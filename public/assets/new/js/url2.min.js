...
var SearchAction = {
    ...
    initFilterControls: function () {
        ...
        var flags = ["has_selling_stock", "has_ready_to_shipment", "is_fake", "only_plus", "only_fresh"];
    ...
    getProductsForFilters: function (page, lastFilter, scrollToProductsList) {
        ...
        if ((val = $('input[name=searchInput]').val() || (!thiz.queryRemoved && url.getParam('filter[search]')))) {
            thiz.url.setParam('filter[search]', (!!url.getParam('filter[search]') && url.getParam('filter[search]') !== val ? url.getParam('filter[search]') + ' ' : '') + val);
            $('input[name=searchInput]').val('');
        } else {
...
var ProductsIndexAction = {
    ...
    AB_initCloseDidYouMean: function(){
        $('.js-close-did-you-mean-box').click(function () {
            $(this).closest('.js-ab-did-you-mean').remove();
        })
    },
