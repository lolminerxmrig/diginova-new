            ...
            g = {
                ...
                show: function (t) {
                    ...
                    if (((t = void 0 === t ? this.state.inputText : t), (!c || d || o.templates.dropdownItemNoMatch) && !1 !== o.dropdown.enable && !this.state.isLoading)) {
                        if (
                            ...
                            t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t), o.templates.dropdownItemNoMatch && (a = o.templates.dropdownItemNoMatch.call(this, { value: t }))),
                                !a)
                        ) {
                            if (this.suggestedListItems.length) t && d && !this.state.editing.scope && !s(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({ value: t });
                            else {
                        ...
                        this.state.dropdown.visible || setTimeout(this.dropdown.events.binding.bind(this)),
                            ...
                            (this.state.selection = { anchorOffset: r.anchorOffset, anchorNode: r.anchorNode }),
                        h ||
                        setTimeout(function () {
                ...
                position: function (t) {
                    if ("manual" != this.settings.dropdown.position) {
                        ...
                        ("text" == c
                            ...
                            (a = Math.ceil(a)),
                            (e = d - i.bottom < t),
                            (l.style.cssText = "left:" + (n + window.pageXOffset) + "px; width:" + o + ";" + (e ? "top: " + (s + window.pageYOffset) + "px" : "top: " + (a + window.pageYOffset) + "px")),
                ...
                selectOption: function (t) {
                    ...
                    if ((this.trigger("dropdown:select", { data: o, elm: t }), n && o)) {
                        if (
                            (this.state.editing ? this.onEditTagDone(null, d({ __isValid: !0 }, o)) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([o], s),
                                setTimeout(function () {
        ...
        var p = {
            ...
            callbacks: {
                onFocusBlur: function (t) {
                    ...
                    if (!o && !r)
                        if (((this.state.hasFocus = "focus" == s && +new Date()), this.toggleFocusClass(this.state.hasFocus), "mix" != i.mode)) {
                            ...
                            "blur" == s &&
                            (this.trigger("blur", n), this.loading(!1), ("select" == this.settings.mode ? !this.value.length || this.value[0].value != e : e && !this.state.actions.selectOption && i.addTagOnBlur) && this.addTags(e, !0)),
                    ...
                    if ((this.trigger("keydown", { originalEvent: this.cloneEvent(t) }), "mix" == this.settings.mode)) {
                        switch (t.key) {
                            ...
                            case "Backspace":
                                ...
                                if (
                                    ((l || d) && 1 == r.anchorNode.nodeType ? (s = 0 == r.anchorOffset ? (l ? g[0] : null) : g[r.anchorOffset - 1]) : l ? (s = r.anchorNode.nextElementSibling) : d && (s = d),
                                ...
                                this.isFirefox && 1 == r.anchorNode.nodeType && 0 != r.anchorOffset && (this.removeTags(), this.placeCaretAfterNode(this.setRangeAtStartEnd())),
                                    setTimeout(function () {
                                        var t = document.getSelection(),
                                            i = a(e.DOM.input.innerHTML),
                                            s = t.anchorNode.previousElementSibling;
                                        if (!h && i.length >= c.length && s && !s.hasAttribute("readonly") && (e.removeTags(s), e.fixFirefoxLastTagNoCaret(), 2 == e.DOM.input.children.length && "BR" == e.DOM.input.children[1].tagName))
                ...
                onMixTagsInput: function (t) {
                    ...
                    if (
                        ("deleteContentBackward" == t.inputType && h && this.events.callbacks.onKeydown.call(this, { target: t.target, key: "Backspace" }),
                            this.value.slice().forEach(function (t) {
                                t.readonly && !v.includes(t.value) && f.appendChild(c.createTagElem(t));
                            }),
                        f.childNodes.length && (m.insertNode(f), this.setRangeAtStartEnd(!1, f.lastChild)),
                        p.length != u)
                    )
                        return (
                    ...
                    if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                        if (
                            ((m = o.getRangeAt(0).cloneRange()).collapse(!0),
                                ...
                                (s = (e = m.toString().slice(0, m.endOffset)).split(g.pattern).length - 1),
                            (i = e.match(g.pattern)) && (a = e.slice(e.lastIndexOf(i[i.length - 1]))),
                                a)
                        ) {
                            if (
                                ((this.state.actions.ArrowLeft = !1),
                                    (this.state.tag = { prefix: a.match(g.pattern)[0], value: a.replace(g.pattern, "") }),
                                    (this.state.tag.baseOffset = o.baseOffset - this.state.tag.value.length),
                                    (l = this.state.tag.value.match(g.delimiters)))
                            )
                                return (
                    ...
                    setTimeout(function () {
                        c.update({ withoutChangeEvent: !0 }), c.trigger("input", d({}, c.state.tag, { textContent: c.DOM.input.textContent })), c.state.tag && c.dropdown[n ? "show" : "hide"].call(c, c.state.tag.value);
                    }, 10);
                },
                ...
                onPaste: function (t) {
                    ...
                    ((e = (t.clipboardData || window.clipboardData).getData("Text")), this.injectAtCaret(e, window.getSelection().getRangeAt(0)), "mix" != this.settings.mode && this.addTags(this.DOM.input.textContent, !0));
                },
                onEditTagInput: function (t, i) {
                    ...
                    r || !0 !== t.originalIsValid || (l = !0),
                        s.classList.toggle(this.settings.classNames.tagInvalid, !0 !== l),
                        (n.__isValid = l),
                        (s.title = !0 === l ? n.title || n.value : l),
                    o.length >= this.settings.dropdown.enabled && (this.state.editing && (this.state.editing.value = o), this.dropdown.show.call(this, o)),
                        this.trigger("edit:input", { tag: s, index: a, data: d({}, this.value[a], { newValue: o }), originalEvent: this.cloneEvent(i) });
                },
            ...
            (f.prototype = {
                ...
                applySettings: function (t, e) {
                    ...
                    if (
                        ...
                        "autoComplete" in e && !l(e.autoComplete) && ((i.autoComplete = u.autoComplete), (i.autoComplete.enabled = e.autoComplete)),
                        "mix" == i.mode && ((i.autoComplete.rightKey = !0), (i.delimiters = e.delimiters || null), i.tagTextProp && !i.dropdown.searchKeys.includes(i.tagTextProp) && i.dropdown.searchKeys.push(i.tagTextProp)),
                            t.pattern)
                    )
                        try {
                ...
                getCaretGlobalPosition: function () {
                    ...
                    if (t.rangeCount) {
                        var e,
                            ...
                            a = s.startContainer,
                            n = s.startOffset;
                        if (n > 0) return (i = document.createRange()).setStart(a, n - 1), i.setEnd(a, n), { left: (e = i.getBoundingClientRect()).right, top: e.top, bottom: e.bottom };
                ...
                build: function (t) {
                    ...
                    this.settings.mixMode.integrated
                        ...
                        : ((e.originalInput = t), (e.scope = this.parseTemplate("wrapper", [t, this.settings])), (e.input = e.scope.querySelector("." + this.settings.classNames.input)), t.parentNode.insertBefore(e.scope, t)),
                ...
                insertAfterTag: function (t, e) {
                    if (((e = e || this.settings.mixMode.insertAfterTag), t && e)) return (e = "string" == typeof e ? document.createTextNode(e) : e), t.parentNode.insertBefore(e, t.nextSibling), e;
                },
                        ...
                        if (!(r instanceof Object && "editable" in r) || r.editable)
                            return (
                                n.setAttribute("contenteditable", !0),
                                    ...
                                    this.tagData(t, { __originalData: d({}, r), __originalHTML: t.innerHTML }),
                                    n.addEventListener("focus", l.onEditTagFocus.bind(this, t)),
                                    n.addEventListener("blur", function () {
                                        setTimeout(function () {
                                            return l.onEditTagBlur.call(c, a());
                                        });
                                    }),
                                    n.addEventListener("input", l.onEditTagInput.bind(this, n)),
                ...
                injectAtCaret: function (t, e) {
                    if ((e = e || this.state.selection.range))
                        return "string" == typeof t && (t = document.createTextNode(t)), e.deleteContents(), e.insertNode(t), this.setRangeAtStartEnd(!1, t), this.updateValueByDOMTags(), this.update(), this;
                },
                input: {
                    set: function () {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                    ...
                    autocomplete: {
                        ...
                        set: function (t) {
                            ...
                            return (
                                !!i &&
                                ("mix" == this.settings.mode ? this.replaceTextWithNode(document.createTextNode(this.state.tag.prefix + i)) : (this.input.set.call(this, i), this.setRangeAtStartEnd()),
                ...
                getWhitelistItem: function (t, e, i) {
                    ...
                    var a,
                        n = this.settings;
                    return (
                        (i = i || n.whitelist).some(function (i) {
                                ...
                                : ("select" == n.mode && (e = !1),
                                    ...
                                    t.forEach(function (t) {
                                        ...
                                        if ((((t = Object.assign({}, r)).__isValid = i.hasMaxTags() || i.validateTag(t)), n.transformTag.call(i, t), !0 !== t.__isValid)) {
                                            if (s) return;
                                            d(o, i.getInvalidTagAttrs(t, t.__isValid), { __preInvalidData: r }), t.__isValid == i.TEXTS.duplicate && i.flashTag(i.getTagElmByValue(t.value));
                                        }
                ...
                addMixTags: function (t) {
                    ...
                    if (t[0].prefix || this.state.tag) this.prefixedTextToTag(t[0]);
                        ...
                        t.forEach(function (t) {
                            ...
                            i
                                ? this.injectAtCaret(s)
                                : (this.DOM.input.focus(),
                                    (i = this.setStateSelection()).range.setStart(this.DOM.input, i.range.endOffset),
                                    i.range.setEnd(this.DOM.input, i.range.endOffset),
                ...
                prefixedTextToTag: function (t) {
                    ...
                    return (
                        s.transformTag.call(this, t),
                            (t.prefix = t.prefix || this.state.tag ? this.state.tag.prefix : (s.pattern.source || s.pattern)[0]),
                ...
                removeTags: function (t, e, i) {
                    ...
                    (t = t && t instanceof HTMLElement ? [t] : t instanceof Array ? t : t ? [t] : [this.getLastTag()]),
                        (s = t.reduce(function (t, e) {
                            return e && "string" == typeof e && (e = a.getTagElmByValue(e)), e && t.push({ node: e, idx: a.getTagIdx(a.tagData(e)), data: a.tagData(e, { __removed: !0 }) }), t;
                        }, [])),
                ...
                update: function (t) {
                    ...
                    this.settings.mixMode.integrated ||
                    (s.value = "mix" == this.settings.mode ? this.getMixedTagsAsString(n) : n.length ? (this.settings.originalInputValueFormat ? this.settings.originalInputValueFormat(n) : JSON.stringify(n)) : ""),
                        this.postUpdate(),
