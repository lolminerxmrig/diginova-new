...
let IndexAction = {
    ...
    initProductFormValidation: function () {
        ...
        let messages = {
            ...
            'product[title_alt]': {
                'maxlength': 'عناوین دیگر طولانی‌تر از حد مجاز است، عناوین دیگر نمی‌تواند طولانی‌تر از 255 کاراکترباشد'
            },
    ...
    initImagesUpload: function () {
        ...
        window.UIkit.upload($uploadGalleryContainer, {
            ...
            beforeSend: function (environment) {
                ...
                environment.headers['X-CSRF-TOKEN'] = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
                },
