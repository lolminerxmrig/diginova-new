...
@section('head')
    <script src="{{ asset('seller/js/edit-warranty-validation.js') }}"></script>
            ...
            <div class="c-content-page c-content-page--plain c-grid__row">
                <div class="c-grid__col">
                    <div class="c-content-page__header">
                        <span class="c-content-page__header-action">  ویرایش گارانتی {{ $warranty->name }}  </span>
                          ...
                          ">
                            ...
                            ">
                                                        ...
                                                        c-grid__col--flex-initial c-grid__col--sm-6">
                                                            ...
                                                            <div class="field-wrapper">
                                                                <input type="text" class="c-content-input__origin js-attribute-old-value"
                                                                       name="name" value="{{ old('name')?? $warranty->name }}">
                                                            </div>
                                                            <div>
                                                            </div>
                                                        </div>
                                                        <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6">
                                                            ...
                                                            <div class="field-wrapper">
                                                                <input type="text" class="c-content-input__origin js-attribute-old-value"
                                                                       name="en_name"  value="{{ old('en_name')?? $warranty->en_name }}">
                                                            </div>
                                                            <div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="c-grid__row c-grid__row--gap-lg" style="margin-right: 0px; width: 100%; margin-bottom: 40px;">
                                                        <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial">
                                                            ...
                                                            <div class="field-wrapper field-wrapper--textarea">
                                                                <textarea name="description" placeholder="توضیحات گارانتی باید بین ۷۰ تا ۱۰۰ کلمه درباره‌ی تاریخچه و محصولات گارانتی باشد …"
                                                                          class="c-content-input__origin c-content-input__origin--textarea js-textarea-words"
                                                                          rows="" maxlength="500">{{ old('description')?? $warranty->description }}</textarea>
...
{{--                                                                       data-status="0" {{ old('type') == 1 ? 'checked' : ($warranty->type == 1 ? 'checked' : '')  }}>--}}
{{--                                                                <span class="c-ui-checkbox__check"></span>--}}
{{--                                                                <span class="c-ui-checkbox__label">ویژه</span>--}}
{{--                                                                <div class="c-wiki c-wiki__holder">--}}
{{--                                  <span class="c-wiki-sign js-tooltip"--}}
{{--                                        data-tooltip="اگر قصد دارید نوع این گارانتی، ویژه شود این گزینه را انتخاب کنید"></span>--}}
{{--                                                                </div>--}}
{{--                                                            </label>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="field-wrapper">
                                                            <input type="text"
                                                                   ...
                                                                   name="slug" dir="ltr"  value="{{ old('slug')?? $warranty->slug }}">
                                                            <input type="button" id="button-urls"
                                                                   style="width: auto;"
                                                                   class="c-ui-tag__submit js-tag-submit-btn button-urls"
                                                                   value="/{{ config('app.url') }}/warranty" disabled>
                                                        </div>
                                                        <div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="c-card__body c-card__body--content category-box">
                                                        <label for="" class="search-form__action-label">گروه کالایی
                                                            فعال در گارانتیتان را انتخاب کنید</label>
                                                    </div>
                                                            ...
                                                            <div class="c-grid__col">
                                                                <fieldset class="c-content-upload">
                                                                    ...
                                                                    <div id="image-container">
                                                                        ...
                                                                        <div id="imagesSection" class="c-content-upload__uploads js-uploaded-section imagesSection2 {{ ($warranty->media)?: 'hide-div' }}"
                                                                        >
                                                                            <h3 class="product-form__section-title product-form__section-title--gap">
                                                                                تصویر بارگذاری شده
                                                                            </h3>
                                                                            ...
                                                                            <ul id="imagesContainer" class="c-content-upload__gallery-list js-uploaded-list js-sortable-list uk-sortable">
                                                                                <li class="c-content-upload__gallery-row js-uploads-row li-error" id="1dsWB">
                                                                                    <div class="c-content-upload__img-container">
                                                                                        @if(count($warranty->media))
                                                                                        <img name="uploaded" id="preview_uploading" src="{{ env('APP_URL') . '/' . $warranty->media()->first()->path . '/'.$warranty->media()->first()->name }}"
                                                                                             data-id="{{ ($warranty->media()->first()->id)? $warranty->media()->first()->id : 0 }}" class="c-content-upload__img js-upload-thumb upload-image">
                                                                                        @else
...
$(document).on("change", "#uploadImage", function () {
    ...
    $.ajax({
        url: '{{route('staff.warranties.uploadUpdate')}}',
        cache: false,
        contentType: false,
        processData: false,
        data: form_data,
