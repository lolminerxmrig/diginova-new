                                      ...
                                      <label class="uk-form-label uk-flex uk-flex-between">
                                        ...
                                        <div class="field-wrapper">
                                            <label class="c-content-input">
                                                <input type="text" placeholder="" class="c-content-input__origin js-required-attribute" name="value" value="">
...
{{--                                                <textarea name="description" placeholder="توضیحات گارانتی باید بین ۷۰ تا ۱۰۰ کلمه درباره‌ی تاریخچه و محصولات گارانتی باشد …" class="c-content-input__origin c-content-input__origin--textarea js-textarea-words" rows="" maxlength="500"></textarea>--}}
...
{{--                                  </div>--}}
                                  ...
                                  <div class="c-card__body c-card__body--content category-box">
                                    <label for="" class="search-form__action-label">گروه کالایی فعال در گارانتیتان را انتخاب کنید                                          <span class="uk-form-label__required"></span>
                                    </label>
...
{{--                                        <legend class="c-content-upload__title">برای گارانتی--}}
{{--                                            لوگو انتخاب کنید--}}
{{--                                        </legend>--}}
    ...
    if (name && en_name && slug && image && (image !== '0') )
    {
        $.ajax({
            ...
            success: function(response) {
                // $.toast({
                //     heading: 'موفق!',
                //     text: "گارانتی با موفقیت ایجاد شد",
                //     bgColor: '#3DC3A1',
                //     textColor: '#fff',
                // });
