<div uk-modal="esc-close: true; bg-close: true;"
     class="uk-modal-container uk-modal-container--message js-common-modal-notification uk-modal" style="display: none;">
        ...
        <div class="uk-modal-body">
            <div class="c-modal-notification">
                <div class="c-modal-notification__content c-modal-notification__content--limited">
                    ...
                    <p class="c-modal-notification__text">با حذف این گارانتی، تمامی محصولاتی که متعلق به این گارانتی می باشند به گارانتی متفرقه منتقل می شوند. آیا از حذف کامل آن اطمینان دارید؟</p>
