...
@section('head')
<script src="{{ asset('seller/js/create-promotion-validation.js') }}"></script>
...
{{--                                  </div>--}}
                                    ...
                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6">
                                        ...
                                        <div class="field-wrapper">
                                            ...
                                            <input type="button" id="button-urls" style="width: auto;" class="c-ui-tag__submit js-tag-submit-btn button-urls" value="/{{ config('app.url') }}/promotion" disabled>
                                        </div>
                                        <div>
                                        </div>
                                    </div>
...
$('#promotion_form').on('submit', function(e){
    ...
    if (name && en_name && slug && image && (image !== '0') )
    {
        $.ajax({
            method: "POST",
            url: '{{ route('staff.promotions.store') }}',
            data: {
                name: name,
                en_name: en_name,
