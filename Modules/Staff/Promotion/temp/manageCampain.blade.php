...
<script src="{{ asset('staff/js/js/landings.js') }}"></script>
<style>
    .c-grid__col--gap-lg {
                    ...
                    <div class="c-grid__col">
                        <div class="c-card c-card--transparent">
                            <h1 class="c-card__title c-card__title--dark c-card__title--desc">تعیین نام و زمان‌بندی نمایش صفحه
                                <span class="c-card__title-sub c-card__title-sub--no-spacing">اطلاعات مورد نیاز را برای قرارگیری در کمپین مشخص کنید.</span>
                            </h1>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="c-add-products__header-section" style="border:none;">
                                    ...
                                    <form class="js-create-plp-form">
                                        ...
                                        <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="width: 166px;float: right;">
                                            <label class="c-ui-form__label" for="product_page_title">ایجاد کمپین</label>
                                    ...
                                    <div class="c-join__buttons">
                                        <button class="c-join__btn c-join__btn--secondary c-join__btn--secondary-greenish c-join__btn--icon-left js-save-list-page-button">تایید و ذخیره کمپین</button>
                                    </div>
