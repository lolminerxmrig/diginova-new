                    ...
                    <form id="attr-group">
                        <div class="c-grid__row c-grid__row--gap-lg mt-30">
                            <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--lg-12">
                                <label for="" class="uk-form-label">نام گروه ویژگی<span class="uk-form-label__required"></span>
                                </label>
                                <div class="field-wrapper c-autosuggest">
                                    <div class="search-form__autocomplete js-autosuggest-box">

                                        <input id="searchKeywordInput" class="uk-input js-prevent-submit" type="text" name="attr_name" placeholder="نام گروه ویژگی را وارد کنید ..."><ul class="c-autosuggest__list-container" style="display: none;"></ul></div>
                        ...
                        <div class="c-grid__row c-grid__row--gap-lg">
                            <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial">
                                ...
                                <div id="brandDescription" class="field-wrapper">
                                    <textarea name="attr_desc" class="uk-textarea" cols="" rows="3" placeholder="توضیحات گروه ویژگی را در صورت تمایل وارد کنید ..."></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
