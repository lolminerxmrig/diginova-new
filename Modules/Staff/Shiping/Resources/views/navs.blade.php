...
@section('content')
  <main class="c-main">
    <div class="uk-container uk-container-large">
      ...
      @include('staffdelivery::layouts.createDeliveryMethodModal')
...
$(document).on('click', '.delete-btn', function () {
  ...
  $(document).on('click', '.yes', function () {
    ...
    $.ajax({
      method: 'post',
      url: "{{route('staff.navs.deleteDeliveryMethod')}}",
      data: {
        'id': nav_id,
...
$('.save-btn').on('click', function (e) {
  ...
  $.ajax({
    method: "post",
    url: '{{route('staff.navs.storeDeliveryMethod')}}',
    data: {
      nav_type: nav_type,
    ...
    success: function () {
      ...
      $.ajax({
        method: "post",
        url: '{{route('staff.navs.reloadDeliveryMethodsTable')}}',
        data: {
          location_id: location_id,
        },
        success: function (result) {
