                      ...
                      ">مدیریت گزینه های کالا
                                          ...
                                          {{ $categories->where('parent_id', $category->id)->count() > 0 ? 'has-children' : '' }}">
                                                    ...
                                                    <div class="editable-section">
                                                        ...
                                                        <label class="uk-form-label edit-form-section" style="margin-right: 30px !important; margin-bottom: -20px; margin-top:40px;">لیست گزینه های:</label>
...
{{--    var cat_id = $("input:checked[type='radio']").val();--}}
    ...
    {{--$.ajax({--}}
    {{--    method: 'post',--}}
    {{--    url: "{{route('staff.ratings.moveToTrash')}}",--}}
    {{--    data: {--}}
    {{--        'id': cat_id,--}}
    {{--    },--}}
    {{--    success: function () {--}}
...
$(".create-field").on('click', function (){
    ...
    field +='<a class="c-ui-btn c-ui-btn--outline-blue edit-field-btn">ویرایش گزینه های</a><a type="button" class="c-content-categories__search-reset remove-field-btn" style="min-height: 39px !important;height: 39px;"></a></div><div></div></div></div>';
