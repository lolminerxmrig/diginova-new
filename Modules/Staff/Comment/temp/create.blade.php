...
@section('head')
<script src="{{ asset('seller/js/create-comment-validation.js') }}"></script>
                                    ...
                                    <div class="c-grid__row c-grid__row--gap-lg"  style="margin-right: 0px; width: 100%; margin-bottom: 40px;">
                                        <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial">
                                            ...
                                            <div class="field-wrapper field-wrapper--textarea">
                                                <textarea name="description" placeholder="توضیحات دیدگاهباید بین ۷۰ تا ۱۰۰ کلمه درباره‌ی تاریخچه و محصولات دیدگاهباشد …" class="c-content-input__origin c-content-input__origin--textarea js-textarea-words" rows="" maxlength="500"></textarea>
...
{{--                                  </div>--}}
                                    ...
                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6">
                                        ...
                                        <div class="field-wrapper">
                                            ...
                                            <input type="button" id="button-urls" style="width: auto;" class="c-ui-tag__submit js-tag-submit-btn button-urls" value="/{{ config('app.url') }}/comment" disabled>
                                        </div>
                                        <div>
                                        </div>
                                    </div>
                              ...
                              <section id="stepImagesAccordion">
                                ...
                                <div class="c-card__body c-card__body--content marketplace-redesign"
                                    ...
                                    <div class="c-grid__col">
                                        ...
                                        <legend class="c-content-upload__title">برای برند
                                            لوگو انتخاب کنید
                                        </legend>
...
$('#comment_form').on('submit', function(e){
    ...
    if (name && en_name && slug && image && (image !== '0') )
    {
        $.ajax({
            method: "POST",
            url: '{{ route('staff.comments.store') }}',
            data: {
                name: name,
                en_name: en_name,
