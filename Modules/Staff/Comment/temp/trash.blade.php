            ...
            <div class="c-grid__row">
                <div class="c-grid__col">
                    <div class="c-card c-card--transparent">
                        <h1 class="c-card__title c-card__title--dark c-card__title--desc">مدیریت دیدگاه های حذف شده<span>
                                از این صفحه می توانید دیدگاه های حذف شده را مدیریت کنید</span>
                        </h1>
                    </div>
                </div>
            </div>
...
{{--                                                    <option value="comment_name" selected>نام برند</option>--}}
{{--                                                    <option value="comment_category">گروه کالا</option>--}}
{{--                                                </select>--}}
{{--                                            </div>--}}
{{--                                            <div--}}
                                ...
                                <div class="c-card__wrapper">
                                    <div class="c-card__header c-card__header--table">
                                        <div class="c-grid__col c-grid__col--lg-4">
                                            <a href="{{ route('staff.comments.index') }}" class="c-ui-btn js-view-all-orders">بازگشت به صفحه مدیریت دیدگاه ها</a>
                                        </div>
                                                ...
                                                <tr name="row" id="{{$comment->id}}" class="c-ui-table__row c-ui-table__row--body c-join__table-row">
                                                    ...
                                                    <td class="c-ui-table__cell" style="min-width: 90px">
                                                        @if(count($comment->media))
                                                            <img src="{{ env('APP_URL') . '/' . $comment->media()->first()->path . '/'.$comment->media()->first()->name }}" width="65" height="65">
                                                        @endif                                                    </td>
                                                    ...
                                                    <td class="c-ui-table__cell">
                                                        <div class="c-promo__actions">
                                                           <button class="c-join__btn c-join__btn--icon-right c-join__btn--secondary-greenish restore-btn"
                                                                value="{{ $comment->id }}">بازگردانی</button>
                                                            ...
                                                            <button class="c-join__btn c-join__btn--icon-right c-join__btn--icon-delete
                                                              c-join__btn--primary js-remove-plp js-remove-product-list delete-btn"
                                                               value="{{ $comment->id }}">حذف کامل</button>
                                                        </div>
                                                    </td>
                                                    </div>
                                                </tr>
                                            ...
                                            <div class="c-join__promotion-info-box c-join__promotion-info-box--empty">
                                                <img class="c-join__promotion-info-img" src="https://seller.digikala.com/static/files/ac21f0e6.svg" alt="Empty">
                                                    ...
                                                    <p class="c-join__promotion-info-statement">
                                                        برای مدیریت دیدگاه ها روی دکمه زیر کلیک کنید.
                                                    </p>
                                                    <a class="c-join__btn c-join__btn--info-box c-join__btn--secondary-greenish"
                                                       href="{{ route('staff.comments.index') }}">مدیریت برندها</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$(document).on('click', '.c-ui-paginator__control a', function(e){
    ...
    var url = "{{route('staff.comments.trashPagination')}}?page="+page;
...
{{--    $.ajax({--}}
{{--        method: 'post',--}}
{{--        url: "{{route('staff.comments.removeFromTrash')}}",--}}
{{--        data: {--}}
{{--            'id': comment_id,--}}
{{--        },--}}
...
$(document).on('click','.restore-btn' , function (){
    ...
    $.ajax({
        method: 'post',
        url: "{{route('staff.comments.restoreFromTrash')}}",
        data: {
            'id': comment_id,
        },
        success: function (response){
