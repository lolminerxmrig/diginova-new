        ...
        <div class="uk-modal-body">
            <div class="c-modal-notification">
                <div class="c-modal-notification__content c-modal-notification__content--limited">
                    ...
                    <p class="c-modal-notification__text">با حذف این برند، تمامی محصولاتی که متعلق به این دیدگاهمی باشند به دیدگاهمتفرقه منتقل می شوند. آیا از حذف کامل آن اطمینان دارید؟</p>
