                ...
                <tr name="row db-row" id="item-{{ $item->id }}" data-id="{{ $item->id }}" 
                  ...
                  <td class="c-ui-table__cell c-ui-table__cell--small-text" style="text-align: center; min-width: 200px;">
                      <span class="c-wallet__body-card-row-item c-ui--fit c-ui--initial">
                        <input type="text" class="c-content-input__origin c-content-input__origin menu_name" name="menu_name"
                         value="{{ $item->name }}" dir="rtl" style="text-align: right;">
                      </span>
                  </td>

                  <td class="c-ui-table__cell c-ui-table__cell--small-text" style="text-align: center; min-width: 200px;">
                      <span class="c-wallet__body-card-row-item c-ui--fit c-ui--initial">
                        <input type="text" class="c-content-input__origin c-content-input__origin menu_link" name="menu_link"
                         value="{{ $item->link }}" dir="rtl" style="text-align: right;">
                      </span>
                  </td>
