        ...
        <div class="uk-modal-body">
            <div class="c-modal-notification">
                <div class="c-modal-notification__content c-modal-notification__content--limited">
                    ...
                    <p class="c-modal-notification__text">با حذف این اسلایدر، تمامی محصولاتی که متعلق به این اسلایدر می باشند به اسلایدر متفرقه منتقل می شوند. آیا از حذف کامل آن اطمینان دارید؟</p>
