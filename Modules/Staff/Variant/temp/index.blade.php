...
{{--                        <div class="c-content-modal__intro">از این بخش می توانید گروه تنوع ایجاد کنید. هدف از ایجاد گروه های تنوع ارائه اطلاعات جزئی محصول به مشتریان است.</div>--}}
{{--                        <div class="c-content-modal__notes">--}}
{{--                            <span class="c-content-modal__notes-title">توجه:</span>--}}
{{--                            <ul class="c-content-modal__notes-list">--}}
{{--                                <li>پس از ایجاد گروه تنوع برای افزودن تنوع به آن، از طریق همین صفحه بر روی دکمه ویرایش کلیک کنید.</li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}

{{--                        <form id="variant-group">--}}
...
{{--                                            <input id="searchKeywordInput" class="uk-input js-prevent-submit" type="text" name="brand[name_fa]" placeholder="نام فارسی برند را وارد کنید …"><ul class="c-autosuggest__list-container" style="display: none;"></ul>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--lg-6">--}}
...
{{--                                            <input id="searchKeywordInput" class="uk-input js-prevent-submit" type="text" name="brand[name_en]" placeholder="عنوان انگلیسی برند …"><ul class="c-autosuggest__list-container" style="display: none;"></ul></div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--lg-6">--}}
{{--                                    <label for="" class="uk-form-label">نام گروه تنوع<span class="uk-form-label__required"></span>--}}
{{--                                    </label>--}}
{{--                                    <div class="field-wrapper c-autosuggest">--}}
{{--                                        <div class="search-form__autocomplete js-autosuggest-box">--}}
...
{{--                                                <option value="1">عبارت کوتاه (text)</option>--}}
{{--                                                <option value="2">متن بلند (textarea)</option>--}}
{{--                                                --}}{{----}}{{--                                                <option value="1" {{ ($variant->type == 1)? 'selected' : '' }}>عبارت کوتاه (text)</option>--}}
{{--                                                --}}{{----}}{{--                                                <option value="2" {{ ($variant->type == 2)? 'selected' : '' }}>متن بلند (textarea)</option>--}}
{{--                                            </select>--}}
{{--                                        <div id="name-error"></div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                            <option value="2" {{ ($variant->type == 2)? 'selected' : '' }}>متن بلند (textarea)</option>--}}
{{--                                        </select>--}}
{{--                                        <input id="searchKeywordInput" class="uk-input js-prevent-submit" type="text" name="brand[name_en]" placeholder="عنوان انگلیسی برند …"><ul class="c-autosuggest__list-container" style="display: none;"></ul>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                        </div>
                            ...
                            <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--lg-6 c-grid__col--row-attr">
                                ...
                                <div id="brandOrigin" class="field-wrapper">
                                    <label class="c-ui-radio c-ui-radio--content c-ui-checkbox--auto">
                                        <input type="radio" class="c-ui-radio__origin js-brand-origin" name="brand[origin]" value="iranian" id="iranianBrandContainer" checked="">
                                    ...
                                    <label class="c-ui-radio c-ui-radio--content c-ui-checkbox--auto">
                                        <input type="radio" class="c-ui-radio__origin js-brand-origin" name="brand[origin]" id="foreignBrandContainer" value="foreign">
                                        <span class="c-ui-radio__check c-ui-radio__check--content"></span>
