                        ...
                        <div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr">
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="order_code" value="{{ persianNum($order->order_code) }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="order_code" value="{{ $order->customer->first_name . ' ' . $order->customer->last_name }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            <label class="c-ui-form__label" for="product_page_title">مبلغ کل:</label>
                            <div class="field-wrapper">
                              <input type="text" name="order_code" value="" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>

                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            <label class="c-ui-form__label" for="product_page_title">تخفیف:</label>
                            <div class="field-wrapper">
                              <input type="text" name="order_code" value="" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="variant_count" value="{{ count($order->consignment_variants) }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-12">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="order_code" value="{{ $order->address->address  . ' پلاک ' . $order->address->plaque }} {{ !is_null($order->address->unit)? ' واحد ' . $order->address->unit : '' }} {{ !is_null($order->address->postal_code)? ' کد پستی ' . $order->address->postal_code : '' }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="recipient_firstname" value="{{ $order->address->recipient_firstname }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="recipient_mobile" value="{{ $order->address->recipient_mobile }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="recipient_national_code" value="{{ $order->address->recipient_national_code }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                            ...
                            <div class="field-wrapper">
                              <input type="text" name="postal_code" value="{{ $order->address->postal_code }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" disabled>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-12">
                            <label class="c-ui-form__label" for="product_page_title">توضیحات:</label>
                              <div class="field-wrapper field-wrapper--textarea enabled">
                                <textarea name="text" id="text" class="c-content-input__origin c-content-input__origin--textarea js-textarea-words" rows="5" maxlength="2000" style="background: white;border-color: #e6e9ed!important;"></textarea>
                              </div>
{{--                              <textarea name="order_code" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" row="4"></textarea>--}}
                          </div>
                        ...
                        <div class="c-commission-accordion__content uk-accordion-content" aria-hidden="false">
                          ...
                          <div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr">
                            ...
                            <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                              ...
                              <div class="field-wrapper">
                                <input type="text" name="order_code" value="" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable">
                              </div>
                            </div>

                            <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-3">
                              <label class="c-ui-form__label" for="product_page_title">وضعیت سفارش:</label>
                              <select class="dropdown-control c-ui-select c-ui-select--common c-ui-select--small select2-hidden-accessible" name="statusss" tabindex="-1" aria-hidden="true">
                                <option class="option-control" value="1" selected>فعال</option>
                                <option class="option-control" value="0">غیرفعال</option>
                              </select>
                            </div>
              ...
              <div class="c-card">
                <div class="c-card__wrapper">
                  ...
                  <div class="c-card__body c-ui-table__wrapper">
                    <table class="c-ui-table js-search-table js-table-fixed-header" data-sort-column="order_id" data-sort-order="desc" data-search-url="/passiveorders/search/" data-auto-reload-seconds="0" data-new-ui="1" data-is-header-floating="1" data-has-checkboxes="" data-export-url="/passiveorders/export/">
                      <thead>
                      <tr class="c-ui-table__row">
                        <th class="c-ui-table__header c-ui-table__header--nowrap " style="transform: none;width: 5% !important;">
                          <span class="js-search-table-column">ردیف</span>
                        </th>
                        <th class="c-ui-table__header c-ui-table__header--nowrap " style="transform: none;width: 8% !important;">
                          <span class="js-search-table-column">کد سفارش/<br>کد مرسوله</span>
                        </th>
                        <th class="c-ui-table__header c-ui-table__header--nowrap " style="transform: none;width: 9% !important;padding-left: 30px !important;">
                          <span class="js-search-table-column">تاریخ ثبت سفارش</span>
                        </th>
                        <th class="c-ui-table__header c-ui-table__header--nowrap " style="transform: none;width: 7% !important;">
                        ...
                        <th class="c-ui-table__header c-ui-table__header--nowrap " style="transform: none;width: 20% !important; padding-left: 20px !important;">
                        ...
                        <th class="c-ui-table__header c-ui-table__header--nowrap " style="transform: none;width: 6% !important;">
                          <span class="js-search-table-column-sortable table-header-searchable" data-sort-column="product_supplier_code" data-sort-order="desc">وزن کالا</span>
                        </th>
                        <th class="c-ui-table__header c-ui-table__header--nowrap " style="transform: none;">
...
{{--                            {{ dd($consignment_variant->product_variant->first->product->product->title_fa) }}--}}

                            <tr class="c-order-history__item-header">
                              <td class="c-order-history__item-index" style="width: 6%;">
                                {{ persianNum($i) }}
                              </td>
                              <td class="c-order-history__package-codes c-order-history__inner-column" style="width: 7% !important;">
                                <span>
                                    {{ $order->order_code }}
                                </span>
                                <span>
                              ...
                              <td class="c-order-history__create-date span-time" style="width: 10% !important;padding-left: -9px !important;padding-right: 21px !important;" data-value="{{ $order->created_at }}"></td>
                              ...
                              <td class="c-order-history__item-image">
                                <img src="https://dkstatics-public.digikala.com/digikala-products/5076202.jpg?x-oss-process=image/resize,m_lfit,h_115,w_115/quality,q_60" alt="" class="">
                              </td>
                              <td class="c-order-history__item-title" style="margin-left: 14px !important;">
                                {{ $consignment_variant->product_variant->first->product->product->title_fa }} | {{ $consignment_variant->product_variant->first->variant->variant->name }} |
                                @if(!is_null($consignment_variant->product_variant->first->warranty->warranty->month))
                                  گارانتی {{ persianNum($consignment_variant->product_variant->first->warranty->warranty->month) }} ماهه {{ $consignment_variant->product_variant->first->warranty->warranty->name }}
                                @else
                                  گارانتی {{ $consignment_variant->product_variant->first->warranty->warranty->name }}
                                @endif
                                {{--                                پاپوش نوزادی طرح عروسکی کد 104 | 8 تا 12 ماه | گارانتی اصالت و سلامت فیزیکی کالا--}}
                                <div class="c-order-history__variant-tag">
                                  {{ $product_code_prefix }}C-{{ $consignment_variant->product_variant->first->variant_code->variant_code }}
                                </div>
                              </td>
                              ...
                              <td class="c-order-history__seller-id" style="width: 10% !important;">
                                <span class="c-commission-table__tag">نیمه سنگین</span>
                              </td>
                              <td class="c-order-history__category">
                                <span class="c-ui-order-status c-ui-order-status--purchased" style="width: 113px !important;">
                                  آماده ارسال
                                </span>
                              </td>
