                  ...
                  <div class="c-ui-form__col c-ui-form__col--3 c-ui-form__col--xs-12 c-ui-form__col--wrap-xs">
                    ...
                    <div class="c-ui-form__controls">
                      <label class="c-ui-switch " id="orders-step-3">
                        <input type="checkbox" class="c-ui-switch__origin js-order-switch-off has-warehouse-inventory js-search-item" name="searchـsend_today_only" value="1">
                      ...
                      <label class="c-ui-switch " id="orders-step-4">
                        <input type="checkbox" class="c-ui-switch__origin js-order-switch-off has-warehouse-inventory js-search-item" name="search_send_tomorrow_only" value="2">
                        <span class="c-ui-switch__label">
                    ...
                    <div class="c-ui-form__controls">
                      ...
                      <label class="c-ui-switch " id="orders-step-3">
                        ...
                        <span class="c-ui-switch__label">
                          ...
                          <span class="c-ui-switch__value ">{{ persianNum($orders->where('order_status_id', 1)->count()) }}</span>
                        </span>
                      </label>
                      ...
                      <label class="c-ui-switch " id="orders-step-4">
                        ...
                        <span class="c-ui-switch__label">
                          ...
                          <span class="c-ui-switch__value ">{{ persianNum($orders->where('order_status_id', 2)->count()) }}</span>
                        </span>
                      </label>
                      ...
                      <label class="c-ui-switch " id="orders-step-4">
                        ...
                        <span class="c-ui-switch__label">
                          ...
                          <span class="c-ui-switch__value ">{{ persianNum($orders->where('order_status_id', 3)->count()) }}</span>
                        </span>
                      </label>
                      ...
                      <label class="c-ui-switch " id="orders-step-4">
                        ...
                        <span class="c-ui-switch__label">
                          ...
                          <span class="c-ui-switch__value ">{{ persianNum($orders->where('order_status_id', 4)->count()) }}</span>
                        </span>
                      </label>
