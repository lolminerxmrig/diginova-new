...
$(".create-field").on('click', function (){
    ...
    field +='<a class="c-ui-btn c-ui-btn--outline-blue edit-field-btn">ویرایش نوع</a><a type="button" class="c-content-categories__search-reset remove-field-btn" style="min-height: 39px !important;height: 39px;"></a></div></div></div>';
