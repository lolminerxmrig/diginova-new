...
<div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr type-field-box appended-box" id="item-{{ $type->id }}">
    ...
    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6">
        <div class="field-wrapper">
            <input type="text" data-old="{{ $type->id }}" data-id="{{ $type->id }}" value="{{ $type->name }}" class="c-content-input__origin c-ui-input--deactive js-suggested-title-fa js-edit-mode-suggested-title-fa type_field database_data" name="database_data" style="margin-left: 10px;" disabled>
