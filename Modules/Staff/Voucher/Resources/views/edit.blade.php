                                            ...
                                            <section class="c-content-accordion__row js-content-section uk-open" id="stepCategoryAccordion">
                                                ...
                                                <div class="c-content-accordion__content c-content-accordion__content--small" id="stepTitleContainer" aria-hidden="false" style="margin-right: -25px;">
                                                    <div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr" style="margin: 0 0 0 0; width: 100%;">
                                                        <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-5">
                                                            ...
                                                            <div class="field-wrapper">
                                                                <input type="text" value="{{ $voucher->name }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable" name="name">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="float: right;width: 166px;">
                                                            ...
                                                            <select id="product-status" class="dropdown-control c-ui-select c-ui-select--common c-ui-select--small select2-hidden-accessible" name="status" data-select2-id="product-status" tabindex="-1" aria-hidden="true" style="width: 150px ​!important;">
                                                                <option class="option-control" value="1" {{ ($voucher->status == 'active')? 'selected' : '' }}>فعال</option>
                                                                <option class="option-control" value="0" {{ ($voucher->status == 'inactive')? 'selected' : '' }}>غیرفعال</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-5" style="margin-top: 10px;">
                                                        ...
                                                        <div class="field-wrapper">
                                                            <input type="text" value="{{ $voucher->code }}" class="c-ui-input__field c-ui-input__field--order c-ui-input__field--has-btn js-form-clearable url-inputs" name="code" dir="ltr" disabled style="padding-left: 165.578px;padding-top: 3px;letter-spacing: 3px !important; text-transform:uppercase;">
                                                                        ...
                                                                        <div class=" c-grid__col c-grid__col--gap-small c-grid__col--flex-initial c-grid__col--xs-gap">
                                                                            <div class="field-wrapper">
                                                                                ...
                                                                                <label class="c-content-input">
                                                                                    <input type="number" value="{{ $voucher->percent }}" placeholder="" class="c-mega-campaigns-join-modal__body-table-input c-mega-campaigns-join-modal__body-table-input--xs js-number-input-wrapper" name="percent" style="max-width: 110px !important;">
                                                                    ...
                                                                    <div class="uk-flex uk-flex-column">
                                                                        <div class=" c-grid__col c-grid__col--gap-small c-grid__col--flex-initial c-grid__col--xs-gap">
                                                                            <div class="field-wrapper">
                                                                                ...
                                                                                <label class="c-content-input">
                                                                                    <input type="number" value="{{ $voucher->up_to }}" placeholder="" class="c-mega-campaigns-join-modal__body-table-input c-mega-campaigns-join-modal__body-table-input--xs js-number-input-wrapper" value="" name="up_to" style="max-width: 110px !important;">
                                                                    ...
                                                                    <div class="uk-flex uk-flex-column">
                                                                        <div class=" c-grid__col c-grid__col--gap-small c-grid__col--flex-initial c-grid__col--xs-gap">
                                                                            <div class="field-wrapper">
                                                                                ...
                                                                                <label class="c-content-input">
                                                                                    <input type="number" value="{{ $voucher->min_product_price }}" placeholder="" class="c-mega-campaigns-join-modal__body-table-input c-mega-campaigns-join-modal__body-table-input--xs js-number-input-wrapper" name="min_product_price" style="max-width: 121px !important;">
                                                                                    <span class="c-content-input__text c-content-input__text--overlay" style="left: 0 !important;right: unset !important;">ریال</span>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr" style="margin-right: 15px;">
                                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--sm-4 c-grid__col--xs-gap" style="width: 26%;">
                                                        ...
                                                        <div class="field-wrapper field-wrapper--justify field-wrapper--background">
                                                            <label class="c-ui-checkbox c-ui-checkbox--small c-ui-checkbox--auto" id="productIsFakeLabel">
                                                                <input type="checkbox" class="c-ui-checkbox__origin" name="has_limit_time" id="productIsFake" value="1" {{ !is_null($voucher->start_at)? 'checked' : '' }}>
                                                    ...
                                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="width: 194px;float: right;">
                                                        ...
                                                        <input class="uk-input c-ui-input__field c-ui-input__field--order js-promotion-date-picker pwt-datepicker-input-element time-input start_at {{ is_null($voucher->start_at)? 'c-ui-input--disabled disabled' : '' }}" value="{{ $voucher->start_at }}" data-format="LLLL" data-time="1" data-from-today="1" data-date="1" data-name="productList_start_at_" id="form-field-dt-26888" autocomplete="off" style="border: 1px solid #e6e9ed !important;" {{ is_null($voucher->start_at)? 'disabled' : '' }}>
                                                        <input name="start_at" id="productList_start_at_" class="start_at_hidden" type="hidden" value="{{ $voucher->start_at }}">
                                                    </div>
                                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="width: 194px;float: right;">
                                                        <label for="form-field-productList[end_at]" class="c-ui-form__label">تاریخ و زمان پایان</label>
                                                        <input class="uk-input c-ui-input__field c-ui-input__field--order js-promotion-date-picker pwt-datepicker-input-element time-input start_at end_at {{ is_null($voucher->end_at)? 'c-ui-input--disabled disabled' : '' }}" value="{{ $voucher->end_at }}" data-format="LLLL" data-time="1" data-from-today="1" data-date="1" data-name="productList_end_at_" value="" id="form-field-dt-26881" autocomplete="off" style="border: 1px solid #e6e9ed !important;" {{ is_null($voucher->end_at)? 'disabled' : '' }}>
                                                        <input name="end_at" name="end_at" class="end_at_hidden" id="productList_end_at_" type="hidden" value="{{ $voucher->end_at }}">
                                                    </div>
                                                </div>
...
">
                                                        ...
                                                        <div class="field-wrapper field-wrapper--justify field-wrapper--background">
                                                            <label class="c-ui-checkbox c-ui-checkbox--small c-ui-checkbox--auto" id="productIsFakeLabel">
                                                                <input type="checkbox" class="c-ui-checkbox__origin" name="has_max_usable" value="1" {{ (!is_null($voucher->max_usable))? 'checked' : '' }}>
                                                                <span class="c-ui-checkbox__check"></span>
                                                    ...
                                                    <div class="uk-flex uk-flex-column">
                                                        <div class=" c-grid__col c-grid__col--gap-small c-grid__col--flex-initial c-grid__col--xs-gap">
                                                            <div class="field-wrapper" style="margin-right: 10px;">
                                                                ...
                                                                <label class="c-content-input">
                                                                    <input type="number" value="{{ $voucher->max_usable }}" placeholder="" class="c-mega-campaigns-join-modal__body-table-input c-mega-campaigns-join-modal__body-table-input--xs js-number-input-wrapper maximum_usable {{ is_null($voucher->max_usable)? 'c-ui-input--disabled disabled' : '' }}" name="maximum_usable" style="max-width: 141px !important;margin-left: -10px;"  {{ is_null($voucher->max_usable)? 'disabled' : '' }}>
                                                ...
                                                <div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr" style="margin-right: 15px; margin-top: 45px !important;">
                                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--sm-5 c-grid__col--xs-gap">
                                                        ...
                                                        <div class="field-wrapper field-wrapper--justify field-wrapper--background">
                                                            <label class="c-ui-checkbox c-ui-checkbox--small c-ui-checkbox--auto" id="productIsFakeLabel">
                                                                <input type="checkbox" class="c-ui-checkbox__origin" name="for_new_users" value="1" {{ ($voucher->type == 'first_purchase')? 'checked' : '' }}>
                                                                <span class="c-ui-checkbox__check"></span>
                                                ...
                                                <div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr" style="margin-right: 15px; margin-top: 45px !important;">
                                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--sm-5 c-grid__col--xs-gap">
                                                        ...
                                                        <div class="field-wrapper field-wrapper--justify field-wrapper--background">
                                                            <label class="c-ui-checkbox c-ui-checkbox--small c-ui-checkbox--auto" id="productIsFakeLabel">
                                                                <input type="checkbox" class="c-ui-checkbox__origin" name="has_freeـshipping" value="1" {{ ($voucher->has_freeـshipping == 'true')? 'checked' : '' }}>
                                                                <span class="c-ui-checkbox__check"></span>
                                                ...
                                                <div class="c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr" style="margin-right: 15px; margin-top: 45px !important;">
                                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--sm-5 c-grid__col--xs-gap">
                                                        ...
                                                        <div class="field-wrapper field-wrapper--justify field-wrapper--background">
                                                            <label class="c-ui-checkbox c-ui-checkbox--small c-ui-checkbox--auto" id="productIsFakeLabel">
                                                                <input type="checkbox" class="c-ui-checkbox__origin" name="has_category_limit" id="productIsFake" value="1" {{ ($voucher->categories()->exists())? 'checked' : '' }}>
                                                                <span class="c-ui-checkbox__check"></span>
                                                ...
                                                <div class="c-card__body c-card__body--content category-box" style="margin-top: 45px; {{ (!$voucher->categories()->exists())? 'display: none' : '' }}">
                                                ...
                                                <div class="c-card__body  c-card__body--content category-box" id="stepTitleContent" style="margin-top: -20px; {{ (!$voucher->categories()->exists())? 'display: none' : '' }}">
                                                </div>
...
$(document).on('change', "input[name='category']", function (e) {
    ...
    var categorySelected = $("input[name='category']:checked").data('id');
...
$(document).on('change', "input[type='radio']", function (e) {
    ...
    var bread_id = $("input[type='radio']:checked").data('id');
