                          ...
                          <section class="c-content-accordion__row js-content-section uk-open"
                            ...
                            <div class="c-card__body c-card__body--content">
                                ...
                                <div class="c-ui-tag__textarea c-ui-tag__textarea--inline js-textarea-tags" style="color: #606265;width: 49.5%;margin-bottom: 20px; padding-right:0px; border: none;">
                                    ...
                                    <input type="button" id="button-urls" style="width: auto;" class="c-ui-tag__submit js-tag-submit-btn button-urls" value="/{{ config('app.url') }}/brands" disabled>
                                </div>
                            </div>
                          ...
                          <div class="c-grid__row">
                            <div class="c-grid__col c-grid__col--flex-initial">
                              ...
                              <div class="uk-flex uk-flex-left">
                                <a class="c-ui-btn c-ui-btn--next mr-a" id="submit-form">افزودن برند</a>
                              </div>
                            </div>
                          </div>
                        </div>
...
$(document).on('click', "#submit-form", function(e) {
    ...
    var categories = [];
    $("input[name='categegory_group[]']").each(function(i, element) {
    ...
    var image = $('.uploadImage').attr('data-id');
...
$(document).on('click', "#categoryStepNext", function(e) {
    ...
    var input = '<input type="text" name="categegory_group[]" value="' + cat_id + '" hidden>';

    if(cat_id !== li_id){
        $("#breadcrumbs").append(li);
        $("#breadcrumbs").append(input);
    }
