                                            ...
                                            <div class="c-ui-form__row">
                                                <div
                                                    ...
                                                    <select
                                                        ...
                                                        name="searchGroup" tabindex="-1" aria-hidden="true"
                                                        id="searchGroup">
                                                ...
                                                <div
                                                    class="c-ui-form__col c-ui-form__col--6 c-ui-form__col--xs-12 c-ui-form__col--small-gap c-ui-form__col--wrap-xs c-ui-form__col--xs">
                                                    <label>
                                    ...
                                    <div class="c-card__wrapper">
                                                    ...
                                                    <tr name="row" id="{{$brand->id}}"
                                                        ...
                                                        <td class="c-ui-table__cell" style="min-width: 90px">
                                                            @if(count($brand->media))
                                                                <img
                                                                    src="{{ $site_url . '/' . $brand->media()->first()->path . '/'.$brand->media()->first()->name }}"
                                                                    width="65" height="65">
                                                            @else
                                                                <img
                                        ...
                                        <div class="c-card__footer" style="width: auto;">
                                            ...
                                            <div class="c-ui-paginator js-paginator">
                                                <div class="c-ui-paginator__total" data-rows="۶">
                                                    تعداد نتایج:
                                                    <span name="total" data-id="{{ $brands->total() }}">
                                                ...
                                                <div
                                                    ...
                                                    @if($trashed_brands->count())
                                                        ...
                                                        <p class="c-join__promotion-info-statement">
                                                            شما تعداد
                                                            {{ persianNum($trashed_brands->count()) }}
                                                            برند حذف شده در Trash دارید برای مدیریت و بازگردانی آنها بر
                                                            روی
                                                            دکمه زیر کلیک کنید
                                                        </p>
                                                        <a class="c-join__btn c-join__btn--info-box c-join__btn--secondary-greenish"
                                                           href="{{ route('staff.brands.trash') }}">
                                                            ورود به صفحه Trash
                                                        </a>
                                                    @else
                                                        <p class="c-join__promotion-info-statement c-join__promotion-info-statement--bg">
                                                            شما تا به حال هیچ برندی ایجاد نکرده‌اید
                                                        </p>
                                                        <p class="c-join__promotion-info-statement">
                                                            برای ایجاد برند جدید روی دکمه زیر کلیک کنید.
                                                        </p>
                                                        <a class="c-join__btn c-join__btn--info-box c-join__btn--secondary-greenish"
                                                           href="{{ route('staff.brands.create') }}">
                                                            ایجاد برند جدید
                                                        </a>
                                                    @endif
                                                </div>
