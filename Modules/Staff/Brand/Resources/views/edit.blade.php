                          ...
                          <div class="c-card__body c-card__body--content category-box">
                            ...
                            <div class="c-content-categories__summary">
                              ...
                              <div class="c-content-accordion__step-controls c-content-accordion__step-controls--category">
                                <a class="c-ui-btn c-ui-btn--next mr-a disabled js-continue-btn" id="categoryStepNext">انتخاب دسته</a>
                              </div>
                            </div>
                          </div>
                                        ...
                                        <li class="c-content-upload__gallery-row js-uploads-row li-error" id="1dsWB">
                                          <div class="c-content-upload__img-container">
                                            @if(count($brand->media))
                                              <img name="uploaded" id="preview_uploading" src="{{ $site_url . '/' . $brand->media()->first()->path . '/'.$brand->media()->first()->name }}" data-id="{{ ($brand->media()->first()->id)? $brand->media()->first()->id : 0 }}" class="c-content-upload__img js-upload-thumb upload-image">
                                            @else
                                              <img name="uploaded" id="preview_uploading" src="" data-id="0" class="c-content-upload__img js-upload-thumb upload-image" hidden>
                                            @endif
                  ...
                  <div class="c-grid__row">
                    <div class="c-grid__col c-grid__col--flex-initial">
                      ...
                      <div class="uk-flex uk-flex-left">
                        <button class="c-ui-btn c-ui-btn--next mr-a submit-form-cu" id="submit-form">ویراش برند</button>
                      </div>
                    </div>
                  </div>
                </div>
