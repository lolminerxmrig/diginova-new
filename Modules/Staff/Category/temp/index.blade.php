                            ...
                            <form id="category_form">
                              ...
                              ">
                                ...
                                ">مدیریت دسته ها
                                                    ...
                                                    <a href="{{ route('staff.categories.create') }}" target="_blank" style="float: left;margin-top: -37px;margin-left: 6px;">
...
<script>
    ...
    $('#category_form').on('submit', function (e) {
        ...
        // if ($("#imagesSection").attr('display') !== 'none'){
        //     var img_found = 1;
        // } else {
        //     var img_found = 0;
        // }
    ...
    $(document).on('click', "#categoryStepNext", function (e) {
        // if ($("#stepImagesContent").attr('display') !== 'none')
        // {
        //     if (($("imagesSection").attr('display') !== 'none') && ($('.error-image').length === 0)){
        //         $("uploadImage-error").hide();
        //     }
        // }
