            ...
            <div class="c-grid__row">
                <div class="c-grid__col">
                    <div class="c-card c-card--transparent">
                        <h1 class="c-card__title c-card__title--dark c-card__title--desc">مدیریت دسته های حذف شده<span>
                                از این صفحه می توانید دسته های حذف شده را مدیریت کنید</span>
                        </h1>
                    </div>
                </div>
            </div>
...
{{--                                                    <option value="category_name" selected>نام دسته</option>--}}
{{--                                                    <option value="category_category">گروه کالا</option>--}}
{{--                                                </select>--}}
{{--                                            </div>--}}
{{--                                            <div--}}
...
{{--                                            <p class="c-ui-form__label">نمایش دسته:</p>--}}
...
{{--                                                    <span class="c-join__radio-option">همه دستهها</span>--}}
{{--                                                </label>--}}
{{--                                                <label class="c-join__radio-label">--}}
                        ...
                        <div class="c-grid__col">
                            <div class="c-card">
                                ...
                                <div class="c-grid__col">
                                  --}}
                                {{--
                                <h2 class="c-card__title c-join__tab-card-title">مدیریت دسته ها</h2>
                                --}}
                                {{--
                                ...
                                {{--                                            <a href="/promotion-management/">همه دستهها</a>--}}
                                {{--
                              </li>
                              --}}
                                {{--
                                <li class="c-promo__tab-item c-promo__tab-item--products" data-tab="2">--}}
                                {{--                                            <a href="/promotion-management/products/">دستههای حذف شده</a>--}}
                                {{--
                              </li>
                              --}}
                                {{--
                                            ...
                                            <div class="c-join__promotion-info-box c-join__promotion-info-box--empty">
                                                <img class="c-join__promotion-info-img" src="https://seller.digikala.com/static/files/ac21f0e6.svg" alt="Empty">
                                                    ...
                                                    <p class="c-join__promotion-info-statement">
                                                        برای مدیریت دسته ها روی دکمه زیر کلیک کنید.
                                                    </p>
                                                    <a class="c-join__btn c-join__btn--info-box c-join__btn--secondary-greenish"
                                                       href="{{ route('staff.categories.index') }}">مدیریت دسته ها</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$(document).on('click', '.c-ui-paginator__control a', function(e){
    ...
    var url = "{{route('staff.categories.trashPagination')}}?page="+page;
...
$(document).on('click','.delete-btn' , function (){
    ...
    $.ajax({
        method: 'post',
        url: "{{route('staff.categories.removeFromTrash')}}",
        data: {
            'id': category_id,
        },
...
$(document).on('click','.restore-btn' , function (){
    ...
    $.ajax({
        method: 'post',
        url: "{{route('staff.categories.restoreFromTrash')}}",
        data: {
            'id': category_id,
        },
        success: function (response){
