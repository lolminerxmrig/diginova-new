                              ...
                              ">
                                ...
                                ">مدیریت دسته ها
                                          ...
                                          {{ $categories->where('parent_id', $category->id)->count() > 0 ? 'has-children' : '' }}">
                                                    ...
                                                    <div
                                                        class="edit-form-section edit-form-section-first c-grid__row c-grid__row--gap-lg c-grid__row--negative-gap-attr"
                                                        style="margin: 40px 0 0 0;width: 100%;"
                                                        id="edit-form-section-first">
                                                    ...
                                                    <div class="c-grid__row c-grid__row--gap-lg edit-form-section"
                                                    ...
                                                    <div
                                                        class="edit-form-section c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6">
...
@section('script')
    <script>
        ...
        $(document).on("change", "#uploadImage", function () {
            ...
            $.ajax({
                url: '{{route('staff.categories.uploadUpdate')}}',
                cache: false,
                contentType: false,
                processData: false,
                data: form_data,
