    ...
    <div class="uk-container uk-container-large">
      <div class="c-grid" data-select2-id="137">
        ...
        <div class="c-grid__row">
          <div class="c-grid__col">
            <div class="c-card">
              <form class="category_form"  novalidate="novalidate">
                <div class="c-grid__col">
                          ...
                          <div
                            ...
                            <div
                              ...
                              <label class="c-ui-checkbox c-ui-checkbox--small c-ui-checkbox--auto"
                                ...
                                <input type="checkbox" class="c-ui-checkbox__origin" name="is_main" id="is_main"
                            ...
                            <div class="search-form__autocomplete-container">
                              <div class="search-form__autocomplete js-autosuggest-box">
                                <input id="searchKeyword" class="c-content-input__origin js-prevent-submit" type="text"
                                       placeholder="نام دسته بندی مورد نظر خود را بنویسید، مثال: گوشی موبایل">
                              </div>
                            </div>
                          </div>
                                    ...
                                    <label class="c-content-upload__trigger"
                                      ...
                                      <div uk-form-custom=""
                                        ...
                                        <input name="image" type="file"
                                               ...
                                               style="visibility: hidden;" data-id="0">
                                      </div>
                                      ...
                                      <ul id="imagesContainer"
                                        ...
                                        <li class="c-content-upload__gallery-row js-uploads-row  li-error"
                                          ...
                                          <div
                                            ...
                                            <img name="uploaded" data-id="0" src="" alt=""
...
@section('script')
  ...
  <script>
    ...
    // /categories/child-categories-loader
...
<script>
  ...
  $('#categoriesContainer').on('click', '.js-category-link', function (e) {
    ...
    selectCategoryFromThree($category);
  ...
  function searchForCategoryByQuery (query) {
    let $errorContainer = $('#ajaxErrorCategory');
    $errorContainer.html('');
    $errorContainer.addClass('hidden');

    $.ajax({
      url: '{{route('staff.categories.searchCategories')}}',
      type: 'post',
      data: {
        q: query,
      },
  ...
  $('#searchKeyword').keyup(function () {
    ...
    searchForCategoryByQuery($value);
  });
