          ...
          <div class="c-content-page c-content-page--plain c-grid__row">
            <div class="c-grid__col">
              <div class="c-content-page__header">
                <span class="c-content-page__header-action">ایجاد صفحه</span>
                <span class="c-content-page__header-desc">برای فروشگاه صفحه ایجاد کنید</span>
              </div>
            </div>
          </div>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="margin-top: 14px;">
                                        <label class="uk-form-label uk-flex uk-flex-between">
                                            نامک
                                            <span class="uk-form-label__required"></span>
                                        </label>
                                        <div class="field-wrapper">
                                            ...
                                            <input type="button" id="button-urls" style="width: auto;" class="c-ui-tag__submit js-tag-submit-btn button-urls" value="/{{ config('app.url') }}/pages" disabled>
                                        </div>
                                        <div>
                                        </div>
                                    </div>
                                    <div style="width: 97%;margin: auto;margin-top: 50px;   ">
                                        <div id="editor"></div>
                                    </div>
...
{{--                                            data-tooltip="اگر قصد دارید نوع این صفحه، ویژه شود این گزینه را انتخاب کنید"></span>--}}
{{--                                        </div>--}}
{{--                                      </label>--}}
{{--                                    </div>--}}
{{--                                      --}}
...
{{--                                    <label for="" class="search-form__action-label">گروه کالایی فعال در صفحهتان را انتخاب کنید</label>--}}
{{--                                  </div>--}}
...
{{--                                        <legend class="c-content-upload__title">برای صفحه--}}
{{--                                            لوگو انتخاب کنید--}}
{{--                                        </legend>--}}
...
{{--                                                    <img name="uploaded" data-id="0" id="preview_uploading"--}}
{{--                                                         class="c-content-upload__img js-upload-thumb upload-image" />--}}
                              ...
                              <div class="c-grid__row">
                                <div class="c-grid__col c-grid__col--flex-initial">
                                  ...
                                  <div class="uk-flex uk-flex-left">
                                    <button class="c-ui-btn c-ui-btn--next mr-a submit-form-cu" id="submit-form">افزودن صفحه</button>
                                  </div>
                                </div>
                              </div>
                            </div>
