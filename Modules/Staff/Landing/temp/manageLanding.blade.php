                                ...
                                <div class="c-add-products__header-section">
                                    ...
                                    <form class="c-add-products__form c-add-products__form--no-spacing js-create-plp-form">
                                        ...
                                        <span class="c-ui-form__col c-ui-form__col--group-item" style="width: 215px">
                                            ...
                                            <input class="uk-input c-ui-input__field c-ui-input__field--order js-promotion-date-picker pwt-datepicker-input-element" data-format="LLLL" data-time="1" data-from-today="1" data-date="1" data-name="productList_start_at_" value="{{ $campain->start_at }}" id="form-field-dt-26888" autocomplete="off">
                                            <input name="start_at" id="productList_start_at_" type="hidden" value="{{ $campain->start_at }}">
                                        </span>

                                        <span class="c-ui-form__col c-ui-form__col--group-item" style="width: 215px">
                                            <label for="form-field-productList[end_at]" class="c-ui-form__label">تاریخ و زمان پایان</label>
                                            <input class="uk-input c-ui-input__field c-ui-input__field--order js-promotion-date-picker pwt-datepicker-input-element" data-format="LLLL" data-time="1" data-from-today="1" data-date="1" data-name="productList_end_at_" value="{{ $campain->end_at }}" id="form-field-dt-93319" autocomplete="off">
                                            <input name="end_at" id="productList_end_at_" type="hidden" value="{{ $campain->end_at }}">
                                        </span>
                                        ...
                                        <div class="c-ui-form__col c-ui-form__col--xs-12 c-ui-form__col--group-item c-ui-form__col--wrap-xs c-ui-form__col--xs-full" style="width: 215px">
                                            ...
                                            <select id="product-status" class="dropdown-control c-ui-select c-ui-select--common c-ui-select--small select2-hidden-accessible" name="status" data-select2-id="product-status" tabindex="-1" aria-hidden="true">
                                                <option class="option-control" value="1" {{ ($campain->status)? 'selected' : '' }}>فعال</option>
                                                <option class="option-control" value="0" {{ (!$campain->status)? 'selected' : '' }}>غیرفعال</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="c-ui-form__col c-ui-form__col--xs-12 c-ui-form__col--group-item c-ui-form__col--wrap-xs c-ui-form__col--xs-full" style="width: 215px">
                                            ...
                                            <select id="has_landing" class="dropdown-control c-ui-select c-ui-select--common c-ui-select--small select2-hidden-accessible" name="has_landing" data-select2-id="has_landing" tabindex="-1" aria-hidden="true">
                                                <option class="option-control" value="0" {{ (!isset($campain->landing))? 'selected' : '' }}>خیر</option>
                                                <option class="option-control" value="1" {{ (isset($campain->landing))? 'selected' : '' }}>بله</option>
                                            </select>
                                        </div>
                                    </form>
