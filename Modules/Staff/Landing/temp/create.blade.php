                        ...
                        <div class="c-card__wrapper">
                            ...
                            <div class="c-add-products__header-section" style="border:none;">
                                ...
                                <form class="js-create-plp-form">
                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="width: 319px;float: right;">
                                    ...
                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="float: right;width: 166px;" data-select2-id="4">
                                        ...
                                        <select id="product-status" class="dropdown-control c-ui-select c-ui-select--common c-ui-select--small select2-hidden-accessible" name="status" data-select2-id="product-status" tabindex="-1" aria-hidden="true" style="width: 150px ​!important;">
                                            <option class="option-control" value="1" selected="" data-select2-id="2">فعال</option>
                                            <option class="option-control" value="0" data-select2-id="7">غیرفعال</option>
                                        </select>
                                    </div>

                                    <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6" style="width: 183px;">
                                        <label class="c-ui-form__label" for="product_page_title">ایجاد صفحه سفارشی</label>
                                        <select id="has_landing" class="dropdown-control c-ui-select c-ui-select--common c-ui-select--small select2-hidden-accessible" name="has_landing" data-select2-id="has_landing" tabindex="-1" aria-hidden="true" style="float: right;">
                                            <option class="option-control" value="0" selected="" data-select2-id="4">خیر</option>
                                    ...
                                    <div class="product-form">
                                        <div class="c-grid__col c-grid__col--gap-lg c-grid__col--row-attr c-grid__col--flex-initial c-grid__col--sm-6">
                                            ...
                                            <div class="field-wrapper" style="width: 525px;">
