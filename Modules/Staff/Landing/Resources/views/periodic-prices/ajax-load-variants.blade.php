...
{{--                                            <a target="_blank" href="/join-promotions-list/index/?showAllPublicLandings=1">لیست همه پروموشن‌های فعال</a>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{-- --}}
                        @if(!is_null($product_variants) && count($product_variants))
                        {{ $product_variants->links('staffpromotion::layouts.pagination.custom-pagination') }}
{{--                        {{ $product_variants->links('staffpromotion::layouts.pagination.custom-pagination') }}--}}
                        @endif
