...
@section('head')
    <script src="{{ asset('seller/js/edit-promotion-validation.js') }}"></script>
...
<?php
    $promotion->name = persianNum($promotion->name);
?>
            ...
            <div class="c-content-page c-content-page--plain c-grid__row">
                <div class="c-grid__col">
                    <div class="c-content-page__header">
                        <span class="c-content-page__header-action">  ویرایش برند {{ $promotion->name }}  </span>
                        <span class="c-content-page__header-desc"> از این صفحه می توانید برند  {{ $promotion->name }} را ویرایش کنید</span>
                    </div>
                </div>
            </div>
                                                        ...
                                                        c-grid__col--flex-initial c-grid__col--sm-6">
                                                            ...
                                                            <div class="field-wrapper">
                                                                <input type="text" class="c-content-input__origin js-attribute-old-value"
                                                                       name="name" value="{{ old('name')?? $promotion->name }}">
                                                            </div>
                                                            <div>
                                                            </div>
                                                        </div>
                              ...
                              c-grid__col--sm-6">
                                                            ...
                                                            <div class="field-wrapper">
                                                                <input type="text"
                                                                       ...
                                                                       name="en_name"  value="{{ old('en_name')?? $promotion->en_name }}">
                                                            </div>
                                                            <div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="field-wrapper field-wrapper--textarea">
                                                                <textarea name="description"
                                                                          ...
                                                                          rows="" maxlength="500">{{ old('description')?? $promotion->description }}</textarea>
...
{{--                                                                       data-status="0" {{ old('type') == 1 ? 'checked' : ($promotion->type == 1 ? 'checked' : '')  }}>--}}
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="field-wrapper">
                                                            <input type="text"
                                                                   ...
                                                                   name="slug" dir="ltr"  value="{{ old('slug')?? $promotion->slug }}">
                                                            <input type="button" id="button-urls"
                                                                   style="width: auto;"
                                                                   class="c-ui-tag__submit js-tag-submit-btn button-urls"
                                                                   value="/{{ config('app.url') }}/promotion" disabled>
                                                        </div>
                                                        <div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="c-grid__col">
                                                                <fieldset class="c-content-upload">
                                                                    ...
                                                                    <div id="image-container">
                                                                        ...
                                                                        <div id="imagesSection" class="c-content-upload__uploads js-uploaded-section imagesSection2 {{ ($promotion->media)?: 'hide-div' }}"
                                                                        >
                                                                            <h3 class="product-form__section-title product-form__section-title--gap">
                                                                                تصویر بارگذاری شده
                                                                            </h3>
                                                                            ...
                                                                            <ul id="imagesContainer" class="c-content-upload__gallery-list js-uploaded-list js-sortable-list uk-sortable">
                                                                                <li class="c-content-upload__gallery-row js-uploads-row li-error" id="1dsWB">
                                                                                    <div class="c-content-upload__img-container">
                                                                                        ...
                                                                                        <img name="uploaded" id="preview_uploading" src="{{ env('APP_URL') . '/' . $promotion->media()->first()->path . '/'.$promotion->media()->first()->name }}"
                                                                                             data-id="{{ ($promotion->media()->first()->id)? $promotion->media()->first()->id : 0 }}" class="c-content-upload__img js-upload-thumb upload-image">
                                                                                        @else
...
$(document).on("change", "#uploadImage", function () {
    ...
    $.ajax({
        url: '{{route('staff.promotions.uploadUpdate')}}',
        cache: false,
        contentType: false,
        processData: false,
        data: form_data,
...
$('#promotion_form').on('submit', function (e) {
    ...
    $.ajax({
        method: "POST",
        url: '{{ route('staff.promotions.update') }}',
        data: {
            name: name,
            en_name: en_name,
        ...
        success: function () {
            window.location.href = "{{ route('staff.promotions.index') }}";
        },
        error: function ()
        {
            //
