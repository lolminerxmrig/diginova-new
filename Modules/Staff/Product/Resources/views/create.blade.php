                              ...
                              <div class="c-grid__row c-grid__row--gap-lg">
                                ...
                                <div
                                  ...
                                  <label for="" class="uk-form-label uk-flex uk-flex-between">
                                    ...
                                    {{--                                                                    <a href="#" class="search-link" id="newBrandRequestModalBtn">درخواست برند جدید</a>--}}
                        ...
                        <div class="c-content-accordion__content c-content-accordion__content--last"
                          ...
                          <div class="c-card__body c-card__body--content marketplace-redesign" id="stepImagesContent">
                            <form id="stepImagesForm" novalidate="novalidate">
                              ...
                              {{--                                    <span class="c-ui-radio__check c-ui-radio__check--content"></span>--}}
                              {{--                                    <span class="c-ui-radio__label c-ui-radio__label--content">درخواست عکاسی از محصولات توسط دیجی‌کالا</span>--}}
                              {{--                                  </label>--}}
                              {{--                                </div>--}}
                              {{--                              </div>--}}
                              {{--                              <div class="hidden" id="imagesDKServiceContainer">--}}
                              {{--                                <div class="c-content-upload__digikala">--}}
                              {{--                                  در صورتی که تمایل دارید عکاسی از محصول شما توسط دیجی‌کالا انجام شود، با کلیک بر روی--}}
                              {{--                                  دکمه--}}
                              {{--                                  به صفحه ارسال <span class="em">«درخواست عکاسی توسط دیجی‌کالا»</span>درخواست هدایت--}}
                              {{--                                  می‌شوید. پس--}}
                              ...
                              {{--                                   class="c-ui-btn c-ui-btn--success mb-30">درخواست عکاسی توسط دیجی‌کالا</a>--}}
                              {{--                              </div>--}}
