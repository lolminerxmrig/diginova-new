                                                    ...
                                                    <div class="c-content-categories__container"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="c-content-categories__list">
                                                                <li class="c-content-categories__item  has-children is-active">
                                                                    <label
                                                                        class="c-content-categories__link js-category-link">
                                                                        <input type="radio"
                                                                               class="uk-hidden js-category-data"
                                                                               data-id="8749" value="مد و پوشاک"
                                                                               data-theme="">
                                                                        مد و پوشاک
                                                                    </label>
                                                                </li>
                                                                ...
                                                                <li class="c-content-categories__item  has-children">
                                                                    <label
                                                                        ...
                                                                        <input type="radio"
                                                                               class="uk-hidden js-category-data"
                                                                               data-id="8450"
                                                                               value="خودرو، ابزار و تجهیزات صنعتی"
                                                                               data-theme="">
                                                                ...
                                                                <li class="c-content-categories__item  has-children">
                                                                    <label
                                                                        ...
                                                                        <input type="radio"
                                                                               class="uk-hidden js-category-data"
                                                                               data-id="10012"
                                                                               value="مد و پوشاک دخترانه و پسرانه"
                                                                               data-theme="no_color_no_size">
                                                                        مد و پوشاک دخترانه و پسرانه
                                                                    </label>
                                                                </li>
                                                                <li class="c-content-categories__item  has-children">
                                                                    <label
                                                                ...
                                                                <li class="c-content-categories__item  has-children">
                                                                    <label
                                                                        ...
                                                                        <input type="radio"
                                                                               class="uk-hidden js-category-data"
                                                                               data-id="9565"
                                                                               value="کت،جلیقه و ست رسمی نوزاد"
                                                                               data-theme="sized">
                                                                ...
                                                                <li class="c-content-categories__item  has-children">
                                                                    <label
                                                                        ...
                                                                        <input type="radio"
                                                                               class="uk-hidden js-category-data"
                                                                               data-id="9575"
                                                                               value="پالتو، بارانی و کاپشن نوزاد"
                                                                               data-theme="sized">
                                                                ...
                                                                <li class="c-content-categories__item ">
                                                                    <label
                                                                        ...
                                                                        <input type="radio"
                                                                               class="uk-hidden js-category-data"
                                                                               data-id="9605"
                                                                               value="تی شرت و پولوشرت نوزاد"
                                                                               data-theme="sized">
                                                                        تی شرت و پولوشرت نوزاد
                                                                    </label>
                                                                </li>
                                                                <li class="c-content-categories__item ">
                                                                    <label
                                                        ...
                                                        <div
                                                            class="c-content-categories__wrapper js-category-column">
                                                            <ul class="c-content-categories__list">
                                                                <li class="c-content-categories__item  is-active">
                                                                    <label
                                                                        class="c-content-categories__link js-category-link">
                                                                        <input type="radio"
                                                                               class="uk-hidden js-category-data"
...
{{--                                                        </div>--}}
                                                    ...
                                                    <div
                                                        class="c-grid__row c-grid__row--gap-lg js-product-package-dimension">
                                                        <div
                                        ...
                                        <div
                                            ...
                                            <div class="c-card__body  c-card__body--content"
                                                ...
                                                <form id="titleForm">
                                                    ...
                                                    <div
                                                        class="c-grid__row c-grid__row--gap-lg  js-edite-title-suggested"
                                                        data-edit-mode="true" data-status="approved">
                                                        <div
                                                            class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial c-grid__col--lg-6">
                                                            <label for="" class="uk-form-label">
                                                                نام فارسی کالا:
                                        ...
                                        <div class="c-grid__row">
                                            <div class="c-grid__col c-grid__col--flex-initial">
                                                ...
                                                <div class="uk-flex uk-flex-left">
                                                    <button class="c-ui-btn c-ui-btn--next mr-a "
                                                            id="saveButton">
                                                        ذخیره کالا
                                                    </button>
                                                </div>
