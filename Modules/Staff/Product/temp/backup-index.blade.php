...
{{--                                                        @if($product->media)--}}
{{--                                                        <img src="{{ asset($product->media->path . '/' . $product->media->name) }}" width="40" height="40">--}}
{{--                                                        @endif--}}
{{--                                                    </td>--}}
                                                    ...
                                                    <td class="c-ui-table__cell">
                                                      <a href="/product/?search%5Bcategory_id%5D=5966">
...
{{--                                                                   data-group-id="{{ $attrGroup->id }}" name="status" {{ ($attrGroup->status)? 'checked' : '' }}--}}
                                                            >
...
{{--                          c-join__btn--secondary-greenish" href="{{ route('staff.products.edit', $product->en_name) }}">ویرایش</a>--}}
