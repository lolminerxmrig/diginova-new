...
{{--                                                                </div>--}}
                                        ...
                                        <div class="c-variant__form " id="productVariantsContainer">
                                            <input type="hidden" class="js-static-form-data" name="search[product_id]" value="1072654">
                                                                                    ...
                                                                                    <div class="uk-flex uk-flex-wrap mt-30 w-100">
                                                                                        <div class="c-grid__col c-ui--mt-20 c-grid__col--sm-2 c-grid__col--flex-initial">
                                                                                            ...
                                                                                            <div class="field-wrapper ui-select ui-select__container ">
                                                                                                <select name="product_variant[post_time]"
...
{{--                                                                                        <div class="c-grid__col c-ui--mt-20 c-grid__col--sm-2 c-grid__col--flex-initial">--}}
{{--                                                                                            <span class="uk-form-label">کد محصول فروشنده:</span>--}}
{{--                                                                                            <div class="field-wrapper">--}}
{{--                                                                                                <input type="text" name="product_variant[supplier_code]" class="uk-input js-edit-seller-code disabled" data-default-value="" value="">--}}
{{--                                                                                            </div>--}}
{{--                                                                                        </div>--}}
                                                                                        <div
                                                                                            class="c-grid__col c-ui--mt-20 c-grid__col--sm-2 c-grid__col--flex-initial">
            ...
            <div id="productVariantTemplate" class="hidden">
                <div class="c-variant-box js-new-variant-container" data-max_lead_time="3">
                    ...
                    <div class="c-variant-box__main">
                        <button type="button" class="c-ui-btn c-ui-btn--clear-form c-variant-box__clear-form c-variant-box__clear-form--absolute js-remove-variant" data-attribute-id=""></button>
                        @if($product->category()->first()->variantGroup()->first()->type !== 0)
                        <div class="c-grid__row c-grid__row--gap-lg">
                            ...
                            <div class="c-grid__col c-grid__col--flex-initial c-grid__col--sm-10">
                                ...
                                <div class="field-wrapper ui-select ui-select__container">
                                    <select name="" class="uk-input uk-input--select js-variant-warranty" data-placeholder="لطفا گارانتی را انتخاب کنید">
                                        <option></option>
                                        <option value="0">گارانتی اصالت و سلامت فیزیکی کالا</option>
                                        @if(count($warranties))
...
{{--                            </div>--}}
                            <div class="c-grid__col c-ui--mt-20 c-grid__col--sm-2 c-grid__col--flex-initial">
                                ...
                                <div class="field-wrapper">
                                    <input type="text" data-editable="false" class="uk-input  js-gold-final-price dk-currency js-variant-price" value="0">
                                </div>
                            </div>
