...
<script>
    ...
    var module_marketplace_warehouse_customer_modal = 1;
    ...
    var module_shopping_customer = 1;
    ...
    var module_new_ship_by_seller_customer = 1;
    var module_marketplace_ship_by_seller_customers = 1;
...
<script src="{{ asset('seller/js/edited_datepicker.js') }}"></script>
                    ...
                    <nav class="uk-navbar-container uk-navbar-transparent c-RD-profile--h-70 c-profile-responsive-navbar uk-navbar" uk-navbar="" style="border-bottom: 1px solid #e6e9ed;margin-bottom: 15px; height: 57px">
                      <div class="uk-navbar-left">
                        <ul class="uk-navbar-nav">
                          ...
                          <li class="c-profile-nav--menu-links js-profile-navbar uk-flex uk-flex-column" data-content="addresses" style="padding-top: 5px; padding-bottom: 5px; pointer-events: all;">
...
{{--                            <a class="c-RD-profile__menu-text" href="#store" style=" color: rgb(161, 163, 168) !important;">سفارش‌های مشتری</a>--}}
{{--                            <div class="c-RD-profile__selected-nav" style="display: none;">&nbsp;</div>--}}
{{--                          </li>--}}
                        </ul>
                      </div>
                          ...
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <select class="c-ui-select c-ui-select--common c-ui-select--small c-RD-profile select2-hidden-accessible" name="status"  aria-hidden="true">
                        ...
                        <div class="c-grid__row">
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="first_name" class="c-ui-input__field c-ui-input__RD-field" value="{{ $customer->first_name }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="last_name" class="c-ui-input__field c-ui-input__RD-field" value="{{ $customer->last_name }}"  aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <input class="uk-input c-ui-input__field c-ui-input__field--order js-promotion-date-picker js-persian-date-picker" data-format="YYYY-MM-DD" data-time="1" data-from-today="0" data-date="1" data-name="birthdate" value="{{ $customer->birthdate }}" autocomplete="off">
                        ...
                        <div class="c-grid__row">
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="national_code" class="c-ui-input__field c-ui-input__RD-field" value="{{ $customer->national_code }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="mobile" class="c-ui-input__field c-ui-input__RD-field" value="{{ !is_null($customer->mobile)? 0 . $customer->mobile : '' }}"  aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="email" class="c-ui-input__field c-ui-input__RD-field" value="{{ $customer->email }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="c-grid__row">
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="bank_card_number" class="c-ui-input__field c-ui-input__RD-field" value="{{ $customer->bank_card_number }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <select class="c-ui-select c-ui-select--common c-ui-select--small c-RD-profile select2-hidden-accessible" name="newsletters"  aria-hidden="true" disabled>
                                  <option></option>
                        ...
                        <div class="c-grid__row">
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <select class="c-ui-select c-ui-select--common c-ui-select--small c-RD-profile select2-hidden-accessible" name="has_legal_info" data-value="legal" aria-hidden="true">
                          ...
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="company_name" class="c-ui-input__field c-ui-input__RD-field" value="{{ isset($customer->legal->company_name)? $customer->legal->company_name : '' }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="economic_number" class="c-ui-input__field c-ui-input__RD-field" value="{{ isset($customer->legal->economic_number)? $customer->legal->economic_number: '' }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="c-grid__row">
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="registration_number" class="c-ui-input__field c-ui-input__RD-field" value="{{ isset($customer->legal->registration_number)? $customer->legal->registration_number : '' }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="nationalـidentity" class="c-ui-input__field c-ui-input__RD-field" value="{{ isset($customer->legal->nationalـidentity)? $customer->legal->nationalـidentity : '' }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <input type="text" name="company_phone" class="c-ui-input__field c-ui-input__RD-field" value="{{ (isset($customer->legal->phone) && !is_null($customer->legal->phone))? 0 . $customer->legal->phone : '' }}" aria-invalid="false">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="c-grid__row">
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                              ...
                              <div class="c-ui-input">
                                <select class="c-ui-select c-ui-select--common c-ui-select--small c-RD-profile select2-hidden-accessible" name="state" data-value="legal" aria-hidden="true">
                                  <option value="">انتخاب استان</option>
                                  @foreach($states->where('type', 'state') as $state)
                                  <option value="{{ $state->id }}" {{ (isset($customer->legal->city_id) && !is_null($customer->legal->city_id) && ($states->where('id', $customer->legal->city_id)->first()->state_id ) == $state->id)? 'selected' : ''  }}>{{ $state->name }}</option>
                                  @endforeach
                                </select>
                              </div>
                            </div>
                          ...
                          <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4 zone_section" data-value="legal">
                            <div class="c-form citySelect">
                              ...
                              <div class="c-ui-input">
                                <select class="c-ui-select c-ui-select--common c-ui-select--small c-RD-profile select2-hidden-accessible" name="city" data-value="legal" aria-hidden="true">
                                  ...
                                  @if( $customer->legal()->exists() && !is_null($customer->legal->city_id))
                                    @foreach($states->where('id', $customer->legal->city_id)->first()->parent->childs as $city)
                                      <option value="{{ $city->id }}" {{ ($customer->legal->city_id == $city->id)? 'selected' : '' }}>{{ $city->name }}</option>
                                    @endforeach
                                  @endif
                                </select>
                              </div>
                  ...
                  <div class="c-card c-RD-profile__bdrs-top-0 js-profile-content-spinner" style="box-shadow: 0 10px 12px 0 rgba(0, 0, 0, 0.05);">
                    ...
                    <div class="c-card__body c-card__body--form">
                      <div class="c-grid__row">
                            ...
                            <div class="c-grid__row">
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4 zone_section" data-value="state-{{ $item->id }}">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <select class="c-ui-select--common c-ui-select--small js-select-origin select2-hidden-accessible" name="state" data-name="state"  data-value="state-{{ $item->id }}" aria-hidden="true">
                                      <option value="">انتخاب استان</option>
                                      @foreach($states->where('type', 'state') as $state)
                                        @if($item->state->type == 'district')
                                          <option value="{{ $state->id }}" {{ ($item->state->parent->parent->id == $state->id)? 'selected' : '' }}>{{ $state->name }}</option>
                                        @else
                                          <option value="{{ $state->id }}" {{ ($item->state->parent->id == $state->id)? 'selected' : '' }}>{{ $state->name }}</option>
                                        @endif
                                      @endforeach
                              ...
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4 zone_section" data-value="state-{{ $item->id }}">
                                <div class="c-form citySelect">
                                  ...
                                  <div class="c-ui-input">
                                    <select class="c-ui-select--common c-ui-select--small js-select-origin select2-hidden-accessible" name="city" data-id="{{ $item->id }}" data-name="city" data-value="" aria-hidden="true">
                                      <option value="">انتخاب شهر</option>
                                      @if($item->state->type == 'district')
                                        @foreach($item->state->parent->parent->childs->where('type', 'city') as $city)
                                          <option value="{{ $city->id }}" {{ ($item->state->parent->id == $city->id)? 'selected' : '' }}>{{ $city->name }}</option>
                                        @endforeach
                                      @elseif($item->state->type == 'city')
                                        @foreach($item->state->parent->childs->where('type', 'city') as $city)
                                          <option value="{{ $city->id }}" {{ ($item->state->id == $city->id)? 'selected' : '' }}>{{ $city->name }}</option>
                                        @endforeach
                                      @endif
                                    </select>
                                  </div>
                                ...
                                <div class="c-form districtSelect">
                                  ...
                                  <div class="c-ui-input deletable_district">
                                    <select class="c-ui-select--common c-ui-select--small js-select-origin select2-hidden-accessible" name="district" data-id="{{ $item->id }}" data-name="district" data-value="customer_address" aria-hidden="true">
                                      ...
                                      <option value="{{ $district->id }}" {{ ($item->state_id == $district->id)? 'selected' : '' }}>{{ $district->name }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                  @endif
                            ...
                            <div class="c-grid__row">
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-12">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="address" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->address }}" aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="c-grid__row">
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="plaque" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->plaque }}" aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="unit" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->unit }}"  aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="postal_code" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->postal_code }}" aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="c-grid__row">
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="lan" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->lan }}" aria-invalid="false" disabled>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="len" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->len }}" aria-invalid="false" disabled>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="c-grid__row">
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="recipient_firstname" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->recipient_firstname }}" aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="recipient_lastname" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->recipient_lastname }}"  aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="recipient_national_code" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->recipient_national_code }}" aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="c-grid__row" style="margin-bottom: 40px !important;">
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                                <div class="c-form">
                                  ...
                                  <div class="c-ui-input">
                                    <input type="text" name="recipient_mobile" class="c-ui-input__field c-ui-input__RD-field" value="{{ $item->recipient_mobile }}" aria-invalid="false">
                                  </div>
                                </div>
                              </div>
                              <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4"></div>
                        ...
                        <div class="c-ui-form__row c-RD-profile__form-action js-profile-form-action" style="margin-right: auto">
                          <div class="c-RD-profile__cancel-btn uk-flex uk-flex-center uk-flex-middle js-profile-cancel-edit-form">بازگشت</div>
                          <div class="c-RD-profile__approve-btn uk-flex uk-flex-center uk-flex-middle uk-margin-small-right save_tab_form" data-value="addresses">ذخیره تغییرات</div>
                        </div>
