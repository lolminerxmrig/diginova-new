...
@section('head')
<script src="{{ asset('seller/js/confirmEmailAction.js') }}"></script>
@endsection
...
<aside class="c-new-login__sidebar c-new-login__sidebar--xs">
  ...
  <main class="c-new-login__main">
    <div class="c-reg-form">
      <form method="post" id="email-form" data-name="register" novalidate="novalidate">
        <input type="hidden" name="rc" value="bVJvbXJSWStnS0J1Y1hjKzYyQXBndz09"><input type="hidden" name="rd" value="Ulp3VjUxMmFVeWR3Y2hQOTZvZjZSZjhUbVB1WVIzUmJCQVYwNU1XMmZFV1dabDY4bWFtZ25ET1d1Q2JxSXV2cQ~~">
        <div class="c-reg-form__row">
          <div class="c-reg-form__col c-reg-form__col--12">
            <p class="c-reg-form__text c-reg-form__text--condensed c-reg-form__text--pane c-reg-form__text--pane-light">
              <span class="c-reg-form__text--highlight c-reg-form__text-label">توجه: </span> ایمیل فعالسازی برای شما ارسال شده است. در صورتی که ایمیل مربوطه در <span class="c-reg-form__text--highlight">Inbox</span> شما نیست، پوشه <span class="c-reg-form__text--highlight">Spam</span> ایمیل خود را نیز بررسی نمایید و حتماً در ایمیل دریافتی بر روی <span class="c-reg-form__text--highlight">Report Not Spam</span> کلیک کنید تا ایمیل های ارسالی از طرف دیجی‌کالا در پوشه <span class="c-reg-form__text--highlight">Inbox</span> شما قرار بگیرد.
            </p>
          </div>
        </div>
        <div class="c-reg-form__row c-reg-form__row--gap-40">
          <div class="c-reg-form__col c-reg-form__col--12">
            <div class="c-ui-input">
              <input type="text" name="" class="c-ui-input__field c-ui-input__field--ltr c-ui-input__field--has-icon c-ui-input__field--has-btn" value="faxoles233@j24blog.com" readonly="" tabindex="-1" disabled="">
              <div class="c-ui-input__icon c-ui-input__icon--email"></div>
              <a href="/registration/" class="c-ui-input__btn c-ui-input__btn--edit"></a>
            </div>
          </div>
        </div>
        <div class="c-reg-form__row c-reg-form__row--align-center">
          <div class="c-reg-form__col c-reg-form__col--12">
            ...
            <div class="c-ui-input">
              <input type="text" name="register[code]" class="c-ui-input__field c-ui-input__field--validation-code" id="register[code]" value="" minlength="4" maxlength="4" autocomplete="off" required="">
              <label for="register[code]" class="c-ui-input__code">
                <div class="c-ui-input__code-digit"></div>
                <div class="c-ui-input__code-digit"></div>
                <div class="c-ui-input__code-digit"></div>
                <div class="c-ui-input__code-digit"></div>
              </label>
        ...
        <div class="c-reg-form__row c-reg-form__row--align-center c-reg-form__row--gap-50">
          <div class="c-reg-form__col">
            <button class="c-reg-form__submit-btn" id="btnSubmit">ثبت کد تأیید</button>
          </div>
        </div>
        <div class="c-reg-form__row c-reg-form__row--align-center c-reg-form__row--gap-40">
          <div class="c-reg-form__col" id="countdown-target">
            <p class="c-reg-form__text" style="visibility: hidden;">کد تأیید دریافت نکرده‌اید؟ <a href="#" id="resend-email-verification-code" class="c-reg-form__link">ارسال مجدد کد تأیید</a></p>
            <div class="c-reg-form__timer"><span>۱:۵۴</span> ثانیه</div>
          </div>
        </div>
      </form>
    </div>
