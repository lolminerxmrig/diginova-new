          ...
          <form method="post" id="details-form" data-name="register">
            ...
            <div class="c-reg-form__row c-reg-form__row--gap-20 ">
              <div class="c-reg-form__col c-reg-form__col--12">
                ...
                <div class="c-ui-input">
                  <input type='text' name='register[business_name]' class='c-ui-input__field' id='business_name' value='' placeholder='نام فروشگاه شما در سایت {{ $site_name }}' maxlength='255' required>
                </div>
              </div>
            </div>
            <div class="c-reg-form__row c-reg-form__row--gap-20 ">
