    ...
    <div class="c-reg-form c-reg-form--login">
      <form method="post" id="login-form" data-name="login" novalidate="novalidate">
        <div class="c-reg-form__row">
          <div class="c-reg-form__col c-reg-form__col--12">
            <div class="c-ui-input">
              <input type="text" name="login[email]" class="c-ui-input__field c-ui-input__field--ltr c-ui-input__field--has-icon" value="" placeholder="ایمیل خود را وارد کنید" maxlength="255" autocomplete="email" required="" aria-invalid="false">
        ...
        <div class="c-reg-form__row">
          <div class="c-reg-form__col c-reg-form__col--12">
            <div class="c-ui-input">
              <input type="password" name="login[password]" class="c-ui-input__field c-ui-input__field--ltr c-ui-input__field--has-icon c-ui-input__field--has-btn" placeholder="کلمه عبور خود را وارد کنید" minlength="4" maxlength="255" autocomplete="current-password" required="" aria-invalid="false">
        ...
        <div class="c-reg-form__row c-reg-form__row--gap-40 c-reg-form__row--align-center">
          <div class="c-reg-form__col">
            <div class="c-ui-checkbox__group">
              ...
              <input class="c-ui-checkbox__origin " type="checkbox" name="login[remember]" value="true">
        ...
        <div class="c-reg-form__row c-reg-form__row--align-center c-reg-form__row--gap-40">
          <div class="c-reg-form__col">
            <p class="c-reg-form__text"><a href="#" class="c-reg-form__link">رمز عبورم را
              فراموش کرده ام.</a>
            </p>
          </div>
        </div>
        <div class="c-reg-form__row c-reg-form__row--align-center c-reg-form__row--gap-40">
          <div class="c-reg-form__col">
            <p class="c-reg-form__text">هنوز ثبت نام نکرده‌اید؟ <a href="#" class="c-reg-form__link">همین حالا ثبت
              نام کنید</a>
            </p>
          </div>
        </div>
