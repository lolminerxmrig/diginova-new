    ...
    <ul class="c-checkout-bill__summary">
          ...
          <div class="c-checkout-bill__shipping-history js-normal-delivery ">
            ...
            <div class="c-checkout-bill__shipping-history-container">
              ...
              >
                        ...
                        مرسوله
                        ۱
                        <span class="c-checkout-bill__shipping-history-title--dropOffShipping">
                        ارسال به مرکز تحویل دیجی کالا
                        </span>
                        </span>
                <span
                  class="c-checkout-bill__shipping-history-price c-checkout-bill__shipping-history-price--free-plus c-digiplus-sign--after js-package-row-plus-free-amount u-hidden">
                        <span class="c-checkout__plus-delivery-counter">
                        از ۰
                        </span>
                        رایگان پلاس
                        </span>
                ...
                <span class="c-checkout-bill__shipping-history-price--free js-package-row-free-amount ">
                        رایگان
                        </span>
              </div>
            </div>
      ...
      <li class="c-checkout-bill__total-price">
        ...
        <span class="c-checkout-bill__total-price--amount" id="cartPayablePrice">
            <span class="js-price" data-price="82975000">
            ۸,۲۹۷,۵۰۰
            </span>
