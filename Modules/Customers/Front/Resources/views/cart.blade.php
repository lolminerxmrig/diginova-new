                    ...
                    <div class="c-checkout js-checkout">
                      <div class="c-checkout__group">
                        <ul class="c-checkout__items">
                          ...
                          @foreach($carts->where('type', 'first') as $cart)
                            <?php
                            ...
                            <li class="c-checkout__item">
                              <div class="c-cart-item" data-price-change="0" data-min-price-badge="">
                                <div class="c-cart-item__thumb">
                                  <a
                                    class="c-cart-item__thumb-img {{ (!$has_count)? 'c-cart-item__thumb--inactive' : '' }}"
                                    ...
                                    @foreach($product->media as $image)
                                      @if($product->media && ($image->pivot->is_main == 1))
                                        <img alt="{{ $product->title_fa }}"
                                             src="{{ $site_url . '/' .$image->path . '/' . $image->name }}?x-oss-process=image/resize,m_lfit,h_350,w_350/quality,q_60"></a>
                                  @endif
                                  @endforeach
                                </div>
                                <div class="c-cart-item__data">
                                  ...
                                  @if ($has_count)
                                    <div
                                      ...
                                      قیمت این کالا ۱,۹۰۰,۰۰۰ تومان کاهش یافته است.
                                    </div>
                                    <div
                                      class="c-cart-notification c-cart-notification--warning c-cart-notification--arrow-up">
                                      قیمت این کالا ۸۵۰ تومان افزایش یافته است.
                                    </div>
                                  @endif
                                  ...
                                  @if (!is_null($cart->promotion_price) && (($cart->sale_price - $cart->promotion_price) > 0) && $has_count)
                                    <div class="c-cart-item__discount">
                                      تخفیف
                                      <span>
                                        {{ persianNum(number_format(toman($cart->sale_price - $cart->promotion_price))) }}
                                    </span>
                                      تومان
                                    </div>
                                  @endif
                                  ...
                                  @if ($has_count)
                                    <div class="c-cart-item__price-row">
                                      ...
                                      <div class="c-cart-item__product-price">
                                        {{ !is_null($cart->promotion_price)? persianNum(number_format(toman($cart->promotion_price))) : persianNum(number_format(toman($cart->sale_price))) }}
                                        <span>
                                      تومان
                                      </span>
                                      </div>
