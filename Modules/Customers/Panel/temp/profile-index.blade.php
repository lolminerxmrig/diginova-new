@extends('layouts.customer.panel-master')
                ...
                <div class="c-profile-stats">
                    ...
                    <div class="c-profile-stats__row">
                        ...
                        <div class="c-profile-stats__col">
                            <p>
                                <span>کد ملی:</span>
                                {{ !is_null($customer->national_code)? $customer->national_code : '' }}
                            </p>
                        </div>
                    </div>
                    <div class="c-profile-stats__row">
                    ...
                    <div class="c-profile-stats__action">
                        <a href="{{ route('customer.panel.personalInfo') }}" class="btn-link-spoiler btn-link-spoiler--edit">ویرایش اطلاعات شخصی</a>
                    </div>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="c-profile-recent-fav">
                    <div class="c-profile-recent-fav__content">
                        <div class="c-profile-recent-fav__row js-favorite-product">
                            <a href="https://www.digikala.com/product/dkp-769647/" class="c-profile-recent-fav__col c-profile-recent-fav__col--thumb">
                                <img data-src="https://dkstatics-public.digikala.com/digikala-products/3490996.jpg?x-oss-process=image/resize,m_fill,h_150,w_150/quality,q_60" alt="هندزفری سلبریت مدل D1">
                            </a>
                            ...
                            <div class="c-profile-recent-fav__col c-profile-recent-fav__col--actions">
                                <button class="btn-action btn-action--remove js-remove-favorite-product" data-product-id="769647"></button>
                            </div>
                        </div>
                        <div class="c-profile-recent-fav__row js-favorite-product">
                            <a href="https://www.digikala.com/product/dkp-1492772/" class="c-profile-recent-fav__col c-profile-recent-fav__col--thumb">
                                <img data-src="https://dkstatics-public-2.digikala.com/digikala-products/110490415.jpg?x-oss-process=image/resize,m_fill,h_150,w_150/quality,q_60" alt="هندزفری بلوتوث مدل SP01">
                            </a>
                            <div class="c-profile-recent-fav__col c-profile-recent-fav__col--title">
                            ...
                            <div class="c-profile-recent-fav__col c-profile-recent-fav__col--actions">
                                <button class="btn-action btn-action--remove js-remove-favorite-product" data-product-id="1492772"></button>
                            </div>
                        </div>
                        <div class="c-profile-recent-fav__row js-favorite-product">
                            <a href="https://www.digikala.com/product/dkp-310914/" class="c-profile-recent-fav__col c-profile-recent-fav__col--thumb">
                                <img data-src="https://dkstatics-public.digikala.com/digikala-products/3092427.jpg?x-oss-process=image/resize,m_fill,h_150,w_150/quality,q_60" alt="هندزفری مدل EO-IG955">
                            </a>
                            <div class="c-profile-recent-fav__col c-profile-recent-fav__col--title">
                            ...
                            <div class="c-profile-recent-fav__col c-profile-recent-fav__col--actions">
                                <button class="btn-action btn-action--remove js-remove-favorite-product" data-product-id="310914"></button>
                            </div>
                        </div>
                    </div>
                    <div class="c-profile-recent-fav__action">
                        <a href="{{ route('customer.panel.favorites') }}" class="btn-link-spoiler btn-link-spoiler--edit">مشاهده و ویرایش لیست مورد علاقه</a>
                    </div>
                </div>
            </div>
        </div>
