<html class="" style="" dir="rtl"><head>
  ...
  <link rel="stylesheet" href="/static/merged/3f00bacf.css">
...
<main class="c-main">
  <div class="uk-container uk-container-large">
    <div class="c-notfound o-spacing-p-l-6 o-spacing-p-r-6">
      <div class="c-notfound__container uk-height-1-1 uk-flex uk-flex-column uk-flex-middle">
        <img src="https://seller.digikala.com/static/files/881a45b8.svg" alt="">
        <p class="o-font-size-16 c-notfound__message">
          متأسفانه صفحه مورد نظر شما یافت نشد.
        </p>
        <a href="/">
          <p class="o-font-size-14 c-notfound__back">
            بازگشت به داشبورد عملکردی
          </p>
        </a>
      </div>
    </div>
    ...
    <div class="uk-container uk-container-large">
      <div class="uk-flex uk-flex-between uk-flex-middle">
        <ul class="uk-subnav uk-subnav-divider">
          ...
          <li><span uk-icon="icon: receiver;" class="uk-icon"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" ratio="1"> <path fill="none" stroke="#000" stroke-width="1.01" d="M6.189,13.611C8.134,15.525 11.097,18.239 13.867,18.257C16.47,18.275 18.2,16.241 18.2,16.241L14.509,12.551L11.539,13.639L6.189,8.29L7.313,5.355L3.76,1.8C3.76,1.8 1.732,3.537 1.7,6.092C1.667,8.809 4.347,11.738 6.189,13.611"></path></svg></span> ۰۲۱ - ۶۱۹۳۰۶۰۰</li>
          <li>ارتباط با مرکز فروشندگان دیجی‌کالا</li>
        </ul>
        <div>
          <a href="http://selleracademy.digikala.com/">
            <img src="https://seller.digikala.com/static/files/18a7352a.svg" class="c-footer__logo c-footer__logo--new">
          </a>
        </div>
      </div>
    </div>
  ...
  <div class="c-footer__bottom">
    <div class="uk-container uk-container-large">
      <div class="uk-flex uk-flex-between">
        ...
        <div>Copyright © 2006 - 2021 Digikala.com</div>
      </div>
    </div>
  </div>
</footer>
...
<div id="national-id-restriction-modal" uk-modal="esc-close: false; bg-close: false;" class="uk-modal-container uk-modal" data-id="" data-status="">
